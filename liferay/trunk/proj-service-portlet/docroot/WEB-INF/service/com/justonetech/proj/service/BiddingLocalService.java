...
/**
 * Provides the local service interface for Bidding. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see BiddingLocalServiceUtil
...
public interface BiddingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BiddingLocalServiceUtil} to access the bidding local service. Add custom service methods to {@link com.justonetech.proj.service.impl.BiddingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
