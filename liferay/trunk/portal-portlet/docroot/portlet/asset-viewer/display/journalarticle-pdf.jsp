...
<%
	...
	boolean check = (extension.equals("docx")||extension.equals("doc")||extension.equals("xls")||extension.equals("xlsx")||extension.equals("pdf"));
...
<portlet:renderURL var="infoViewerUrl">
	<portlet:param name="mvcPath" value="${contextPath}/asset-viewer/display/journalarticle.jsp" />
...
<iframe src="<%=portalUrl%>/generic/web/viewer.html?file=<%=url%>" width="98%" height="800px" scrolling="auto" frameborder="0" style="position: relative; left: 1%"> </iframe>
