 ...
 * @generated
 */
public abstract class ConstructionUnitProjectActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ConstructionUnitProjectActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(ConstructionUnitProjectLocalServiceUtil.getService());
		setClass(ConstructionUnitProject.class);

		setClassLoader(com.justonetech.projApproval.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("constructionUnitProjectId");
	}
}