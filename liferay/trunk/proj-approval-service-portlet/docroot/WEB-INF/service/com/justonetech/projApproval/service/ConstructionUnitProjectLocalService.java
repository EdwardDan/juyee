...
/**
 * Provides the local service interface for ConstructionUnitProject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author justonetech
 * @see ConstructionUnitProjectLocalServiceUtil
...
public interface ConstructionUnitProjectLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConstructionUnitProjectLocalServiceUtil} to access the construction unit project local service. Add custom service methods to {@link com.justonetech.projApproval.service.impl.ConstructionUnitProjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
