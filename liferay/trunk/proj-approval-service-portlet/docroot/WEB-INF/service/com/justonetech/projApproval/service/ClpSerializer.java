...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"proj-approval-service-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "proj-approval-service-portlet";
			}
	...
	public static Object translateOutputConstructionPermit(
		BaseModel<?> oldModel) {
		ConstructionPermitClp newModel = new ConstructionPermitClp();
