...
/**
 * Provides the local service interface for LeaderWork. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author justonetech
 * @see LeaderWorkLocalServiceUtil
...
public interface LeaderWorkLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LeaderWorkLocalServiceUtil} to access the leader work local service. Add custom service methods to {@link com.justonetech.oa.service.impl.LeaderWorkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
