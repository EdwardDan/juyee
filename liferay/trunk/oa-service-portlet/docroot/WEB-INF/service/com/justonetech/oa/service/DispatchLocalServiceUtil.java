 ...
 * {@link com.justonetech.oa.service.impl.DispatchLocalServiceImpl} and is the
...
public class DispatchLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.justonetech.oa.service.impl.DispatchLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.justonetech.oa.model.Dispatch addDispatch(
	...
	*/
	public static com.justonetech.oa.model.Dispatch createDispatch(
		long dispatchId) {
		return getService().createDispatch(dispatchId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.oa.model.Dispatch deleteDispatch(
		long dispatchId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDispatch(dispatchId);
	}
	...
	*/
	...
	public static com.justonetech.oa.model.Dispatch fetchDispatch(
		long dispatchId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDispatch(dispatchId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.oa.model.Dispatch getDispatch(long dispatchId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDispatch(dispatchId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.justonetech.oa.model.Dispatch> getDispatchs(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDispatchs(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getDispatchsCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDispatchsCount();
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.oa.model.Dispatch updateDispatch(
		com.justonetech.oa.model.Dispatch dispatch)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static void deleteDispatchs(java.lang.String[] dispatchIds) {
		getService().deleteDispatchs(dispatchIds);
	}
	...
	public static DispatchLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DispatchLocalService.class.getName());

			if (invokableLocalService instanceof DispatchLocalService) {
				_service = (DispatchLocalService)invokableLocalService;
			}
			else {
				_service = new DispatchLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(DispatchLocalServiceUtil.class,
				"_service");
		}
	 ...
	 */
	public void setService(DispatchLocalService service) {
	}

	private static DispatchLocalService _service;
}