...
/**
 * Provides the local service interface for DeptWorkItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author justonetech
 * @see DeptWorkItemLocalServiceUtil
...
public interface DeptWorkItemLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeptWorkItemLocalServiceUtil} to access the dept work item local service. Add custom service methods to {@link com.justonetech.oa.service.impl.DeptWorkItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
