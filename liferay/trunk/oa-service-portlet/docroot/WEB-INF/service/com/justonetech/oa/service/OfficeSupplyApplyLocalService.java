...
/**
 * Provides the local service interface for OfficeSupplyApply. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author justonetech
 * @see OfficeSupplyApplyLocalServiceUtil
...
public interface OfficeSupplyApplyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OfficeSupplyApplyLocalServiceUtil} to access the office supply apply local service. Add custom service methods to {@link com.justonetech.oa.service.impl.OfficeSupplyApplyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
