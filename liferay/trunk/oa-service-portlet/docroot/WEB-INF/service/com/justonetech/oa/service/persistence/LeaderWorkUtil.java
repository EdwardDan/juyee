...
/**
 * The persistence utility for the leader work service. This utility wraps {@link LeaderWorkPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class LeaderWorkUtil {
	 ...
	 */
	public static void clearCache(LeaderWork leaderWork) {
		getPersistence().clearCache(leaderWork);
	}
	 ...
	 */
	public static List<LeaderWork> findWithDynamicQuery(
	 ...
	 */
	public static LeaderWork update(LeaderWork leaderWork)
		throws SystemException {
		return getPersistence().update(leaderWork);
	}
	...
	public static LeaderWork update(LeaderWork leaderWork,
		...
		return getPersistence().update(leaderWork, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(leaderWork);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(leaderWorks);
	}
	...
	*/
	...
	public static com.justonetech.oa.model.LeaderWork updateImpl(
		com.justonetech.oa.model.LeaderWork leaderWork)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(leaderWork);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.justonetech.oa.model.LeaderWork> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static LeaderWorkPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (LeaderWorkPersistence)PortletBeanLocatorUtil.locate(com.justonetech.oa.service.ClpSerializer.getServletContextName(),
					LeaderWorkPersistence.class.getName());

			ReferenceRegistry.registerReference(LeaderWorkUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(LeaderWorkPersistence persistence) {
	}

	private static LeaderWorkPersistence _persistence;
}