...
/**
 * Provides the local service interface for VehicleApplication. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author justonetech
 * @see VehicleApplicationLocalServiceUtil
...
public interface VehicleApplicationLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VehicleApplicationLocalServiceUtil} to access the vehicle application local service. Add custom service methods to {@link com.justonetech.oa.service.impl.VehicleApplicationLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
