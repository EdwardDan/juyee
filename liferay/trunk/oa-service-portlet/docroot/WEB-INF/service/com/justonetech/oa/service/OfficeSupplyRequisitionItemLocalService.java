...
/**
 * Provides the local service interface for OfficeSupplyRequisitionItem. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author justonetech
 * @see OfficeSupplyRequisitionItemLocalServiceUtil
...
public interface OfficeSupplyRequisitionItemLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OfficeSupplyRequisitionItemLocalServiceUtil} to access the office supply requisition item local service. Add custom service methods to {@link com.justonetech.oa.service.impl.OfficeSupplyRequisitionItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
