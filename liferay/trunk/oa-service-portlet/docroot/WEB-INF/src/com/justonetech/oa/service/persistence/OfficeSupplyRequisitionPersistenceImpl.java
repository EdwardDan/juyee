...
public class OfficeSupplyRequisitionPersistenceImpl extends BasePersistenceImpl<OfficeSupplyRequisition>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DEPTNAME = new FinderPath(OfficeSupplyRequisitionModelImpl.ENTITY_CACHE_ENABLED,
			OfficeSupplyRequisitionModelImpl.FINDER_CACHE_ENABLED,
			OfficeSupplyRequisitionImpl.class,
	 ...
	 */
	@Override
	public List<OfficeSupplyRequisition> findByDeptName(String deptName)
		...
		if ((list != null) && !list.isEmpty()) {
			for (OfficeSupplyRequisition officeSupplyRequisition : list) {
				if (!StringUtil.wildcardMatches(
							officeSupplyRequisition.getDeptName(), deptName,
	 ...
	 */
	@Override
	public OfficeSupplyRequisition findByDeptName_First(String deptName,
		OrderByComparator orderByComparator)
		throws NoSuchOfficeSupplyRequisitionException, SystemException {
		OfficeSupplyRequisition officeSupplyRequisition = fetchByDeptName_First(deptName,
				orderByComparator);
	 ...
	 */
	@Override
	public OfficeSupplyRequisition fetchByDeptName_First(String deptName,
		OrderByComparator orderByComparator) throws SystemException {
		List<OfficeSupplyRequisition> list = findByDeptName(deptName, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public OfficeSupplyRequisition findByDeptName_Last(String deptName,
		OrderByComparator orderByComparator)
		throws NoSuchOfficeSupplyRequisitionException, SystemException {
		OfficeSupplyRequisition officeSupplyRequisition = fetchByDeptName_Last(deptName,
				orderByComparator);
	 ...
	 */
	@Override
	public OfficeSupplyRequisition fetchByDeptName_Last(String deptName,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<OfficeSupplyRequisition> list = findByDeptName(deptName,
	 ...
	 */
	@Override
	public OfficeSupplyRequisition[] findByDeptName_PrevAndNext(
		long officeSupplyRequisitionId, String deptName,
		OrderByComparator orderByComparator)
		throws NoSuchOfficeSupplyRequisitionException, SystemException {
		...
		try {
			...
			array[0] = getByDeptName_PrevAndNext(session,
					officeSupplyRequisition, deptName, orderByComparator, true);

			array[1] = officeSupplyRequisition;

			array[2] = getByDeptName_PrevAndNext(session,
					officeSupplyRequisition, deptName, orderByComparator, false);
	...
	protected OfficeSupplyRequisition getByDeptName_PrevAndNext(
		Session session, OfficeSupplyRequisition officeSupplyRequisition,
		String deptName, OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByDeptName(String deptName) throws SystemException {
		for (OfficeSupplyRequisition officeSupplyRequisition : findByDeptName(
				deptName, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	private static final String _FINDER_COLUMN_DEPTNAME_DEPTNAME_1 = "officeSupplyRequisition.deptName LIKE NULL";
	private static final String _FINDER_COLUMN_DEPTNAME_DEPTNAME_2 = "officeSupplyRequisition.deptName LIKE ?";
	private static final String _FINDER_COLUMN_DEPTNAME_DEPTNAME_3 = "(officeSupplyRequisition.deptName IS NULL OR officeSupplyRequisition.deptName LIKE '')";
	 ...
	 */
	@Override
	public List<OfficeSupplyRequisition> findByApplicantName(
		String applicantName) throws SystemException {
	...
	@Override
	public List<OfficeSupplyRequisition> findByApplicantName(
		String applicantName, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		boolean pagination = true;
		FinderPath finderPath = null;
		Object[] finderArgs = null;
		...
		if ((list != null) && !list.isEmpty()) {
			for (OfficeSupplyRequisition officeSupplyRequisition : list) {
				if (!StringUtil.wildcardMatches(
							officeSupplyRequisition.getApplicantName(),
	 ...
	 */
	@Override
	public OfficeSupplyRequisition findByApplicantName_First(
		String applicantName, OrderByComparator orderByComparator)
		throws NoSuchOfficeSupplyRequisitionException, SystemException {
		OfficeSupplyRequisition officeSupplyRequisition = fetchByApplicantName_First(applicantName,
				orderByComparator);
	 ...
	 */
	@Override
	public OfficeSupplyRequisition fetchByApplicantName_First(
		String applicantName, OrderByComparator orderByComparator)
		throws SystemException {
		List<OfficeSupplyRequisition> list = findByApplicantName(applicantName,
	 ...
	 */
	@Override
	public OfficeSupplyRequisition findByApplicantName_Last(
		String applicantName, OrderByComparator orderByComparator)
		throws NoSuchOfficeSupplyRequisitionException, SystemException {
		OfficeSupplyRequisition officeSupplyRequisition = fetchByApplicantName_Last(applicantName,
				orderByComparator);
	 ...
	 */
	@Override
	public OfficeSupplyRequisition fetchByApplicantName_Last(
		String applicantName, OrderByComparator orderByComparator)
		throws SystemException {
	 ...
	 */
	@Override
	public OfficeSupplyRequisition[] findByApplicantName_PrevAndNext(
		long officeSupplyRequisitionId, String applicantName,
		OrderByComparator orderByComparator)
		throws NoSuchOfficeSupplyRequisitionException, SystemException {
		OfficeSupplyRequisition officeSupplyRequisition = findByPrimaryKey(officeSupplyRequisitionId);
		...
		try {
			...
			array[0] = getByApplicantName_PrevAndNext(session,
					officeSupplyRequisition, applicantName, orderByComparator,
					true);
	...
	protected OfficeSupplyRequisition getByApplicantName_PrevAndNext(
		Session session, OfficeSupplyRequisition officeSupplyRequisition,
		String applicantName, OrderByComparator orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByApplicantName(String applicantName)
		throws SystemException {
		for (OfficeSupplyRequisition officeSupplyRequisition : findByApplicantName(
	...
	private static final String _FINDER_COLUMN_APPLICANTNAME_APPLICANTNAME_1 = "officeSupplyRequisition.applicantName LIKE NULL";
	private static final String _FINDER_COLUMN_APPLICANTNAME_APPLICANTNAME_2 = "officeSupplyRequisition.applicantName LIKE ?";
	private static final String _FINDER_COLUMN_APPLICANTNAME_APPLICANTNAME_3 = "(officeSupplyRequisition.applicantName IS NULL OR officeSupplyRequisition.applicantName LIKE '')";
	...
	protected OfficeSupplyRequisition toUnwrappedModel(
		...
		officeSupplyRequisitionImpl.setApplicantId(officeSupplyRequisition.getApplicantId());
		officeSupplyRequisitionImpl.setApplicantName(officeSupplyRequisition.getApplicantName());
