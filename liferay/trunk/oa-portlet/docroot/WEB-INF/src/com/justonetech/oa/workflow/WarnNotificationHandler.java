...
public class WarnNotificationHandler extends BaseUserNotificationHandler{
	public static final String PORTLET_ID = "vehicleapplication_WAR_oaportlet";
    
    public WarnNotificationHandler() {
  
        setPortletId(com.justonetech.oa.workflow.WarnNotificationHandler.PORTLET_ID);
