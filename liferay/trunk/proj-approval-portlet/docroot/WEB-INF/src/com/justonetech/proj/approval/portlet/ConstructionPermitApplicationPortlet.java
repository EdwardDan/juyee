...
//保存
	public void saveConstructionPermit(ActionRequest request, ActionResponse response) throws SystemException, PortalException, ParseException{     
...
//获取基本信息
        ...
        String certificationDate = ParamUtil.getString(request, "certificationDate");*/
 
        //申请材料
      /*  String applyMaterial = ParamUtil.getString(request, "applyMaterial");*/
        
        //还有的是施工许可编码的保存
        /*  String constructionPermitCode = ParamUtil.getString(request, "constructionPermitCode");*/
...
//获取扩展信息
        ...
        Date feasibilityReplyDate = ParamUtil.getDate(request, "feasibilityReplyDate",new SimpleDateFormat(dateFormatPattern));      
        String initialDesignApprovalOrganAndNumber = ParamUtil.getString(request, "initialDesignApprovalOrganAndNumber"); 
        Double investmentEstimation = ParamUtil.getDouble(request, "investmentEstimation");
        Date initialDesignReplyDate = ParamUtil.getDate(request, "initialDesignReplyDate",new SimpleDateFormat(dateFormatPattern));
        String replyProject = ParamUtil.getString(request, "replyProject");
        Double totalBudget = ParamUtil.getDouble(request, "totalBudget");
        String constructionDrawingApprovalOrganAndNumber = ParamUtil.getString(request, "constructionDrawingApprovalOrganAndNumber");
