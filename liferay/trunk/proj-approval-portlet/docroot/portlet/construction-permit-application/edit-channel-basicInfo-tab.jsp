			...
			<table class="table table-bordered">
				...
				<c:forEach var="constructionApplyMaterial" items="${applyMaterials}"
					...
					<tr style="text-align: center">
						...
						<td class="span2" style="text-align: center"><input
							cssClass="image" label=""
							name="${namespace}applyMaterial${constructionApplyMaterial.sortNo}"
							type="file" multiple="multiple"></input></td>
					</tr>
				</c:forEach>
			</table>
		</liferay-ui:panel>
