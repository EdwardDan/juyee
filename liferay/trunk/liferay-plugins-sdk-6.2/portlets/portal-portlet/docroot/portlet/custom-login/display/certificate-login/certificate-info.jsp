	...
	<liferay-ui:panel title="当前证书信息" collapsible="false">
		<table cellpadding="0" cellspacing="0" class="table table-bordered">
			<tr class="tr1">
				...
				<td class="bg-white" id="userOrganization"></td>
			</tr>
			<tr>
				<td class="text-right">机构代码证</td>
				<td class="bg-white"  id="UniqueID"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="bg-white" id="certificateSerialNo"></td>
			</tr>
			<tr>
				<td class="text-right">有效期至</td>
				<td class="bg-white" id="expirationDate"></td>
			</tr>
		</table>
	</liferay-ui:panel>
	<liferay-ui:panel title="附加信息" collapsible="false">
		<table cellpadding="0" cellspacing="0" class="table table-bordered">
			...
			<tr>
				...
				<td class="bg-white" id="userName"></td>
			</tr>
			<tr>
...
<portlet:resourceURL var="certificateInfoURL" id="certificate-info" />
<script type="text/javascript">
	$(function(){ 
		$.ajax({
			type:"GET",
			url:"<%=certificateInfoURL%>",
			data : {
			},
			error : function(err) {
				alert("提交失败!");
			...
			success : function(data) {
				...
				$("#userOrganization").append(strJson.userOrganization);
				$("#UniqueID").append(strJson.UniqueID);
				$("#certificateSerialNo").append(strJson.certificateSerialNo);
				$("#expirationDate").append(strJson.expirationDate);
				$("#userName").append(strJson.userName);
			}
		});
	}); 
</script>
