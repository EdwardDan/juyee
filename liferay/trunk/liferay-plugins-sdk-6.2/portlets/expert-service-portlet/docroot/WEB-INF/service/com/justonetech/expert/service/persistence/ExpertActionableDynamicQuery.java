 ...
 * @generated
 */
public abstract class ExpertActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ExpertActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ExpertLocalServiceUtil.getService());
		setClass(Expert.class);

		setClassLoader(com.justonetech.expert.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("expertId");
	}
}