 ...
 * @generated
 */
public abstract class ZysqlbActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ZysqlbActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ZysqlbLocalServiceUtil.getService());
		setClass(Zysqlb.class);

		setClassLoader(com.justonetech.expert.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("zysqlbId");
	}
}