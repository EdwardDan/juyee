 ...
 * @generated
 */
public abstract class ZzjlActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ZzjlActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ZzjlLocalServiceUtil.getService());
		setClass(Zzjl.class);

		setClassLoader(com.justonetech.expert.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("zzjlId");
	}
}