...
/**
 * Provides the local service interface for Zysqlb. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see ZysqlbLocalServiceUtil
...
public interface ZysqlbLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ZysqlbLocalServiceUtil} to access the zysqlb local service. Add custom service methods to {@link com.justonetech.expert.service.impl.ZysqlbLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
