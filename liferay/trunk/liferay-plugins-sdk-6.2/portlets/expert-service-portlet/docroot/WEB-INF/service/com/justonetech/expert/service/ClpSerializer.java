...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"expert-service-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "expert-service-portlet";
			}
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(ZqtzjkrzqkClp.class.getName())) {
			return translateInputZqtzjkrzqk(oldModel);
		}
	...
	public static Object translateInputXlxx(BaseModel<?> oldModel) {
		XlxxClp oldClpModel = (XlxxClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getXlxxRemoteModel();
	...
	public static Object translateInputZqtzjkrzqk(BaseModel<?> oldModel) {
		ZqtzjkrzqkClp oldClpModel = (ZqtzjkrzqkClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getZqtzjkrzqkRemoteModel();
	...
	public static Object translateInputZysqlb(BaseModel<?> oldModel) {
		ZysqlbClp oldClpModel = (ZysqlbClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getZysqlbRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.justonetech.expert.model.impl.XlxxImpl")) {
			return translateOutputXlxx(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
		...
		if (oldModelClassName.equals(
					"com.justonetech.expert.model.impl.ZqtzjkrzqkImpl")) {
			return translateOutputZqtzjkrzqk(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
		...
		if (oldModelClassName.equals(
					"com.justonetech.expert.model.impl.ZysqlbImpl")) {
			return translateOutputZysqlb(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.justonetech.expert.NoSuchZqtzjkrzqkException")) {
			return new com.justonetech.expert.NoSuchZqtzjkrzqkException();
		}

		if (className.equals("com.justonetech.expert.NoSuchZysqlbException")) {
	...
	public static Object translateOutputXlxx(BaseModel<?> oldModel) {
		XlxxClp newModel = new XlxxClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setXlxxRemoteModel(oldModel);

		return newModel;
	}

	public static Object translateOutputZqtzjkrzqk(BaseModel<?> oldModel) {
		ZqtzjkrzqkClp newModel = new ZqtzjkrzqkClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setZqtzjkrzqkRemoteModel(oldModel);

		return newModel;
	}

	public static Object translateOutputZysqlb(BaseModel<?> oldModel) {
		ZysqlbClp newModel = new ZysqlbClp();
