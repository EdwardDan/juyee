...
/**
 * Provides the local service interface for Zzjl. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see ZzjlLocalServiceUtil
...
public interface ZzjlLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ZzjlLocalServiceUtil} to access the zzjl local service. Add custom service methods to {@link com.justonetech.expert.service.impl.ZzjlLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
