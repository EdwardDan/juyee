...
/**
 * Provides the local service interface for LEOCertificate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see LEOCertificateLocalServiceUtil
...
public interface LEOCertificateLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LEOCertificateLocalServiceUtil} to access the l e o certificate local service. Add custom service methods to {@link com.justonetech.cyzt.leo.service.impl.LEOCertificateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
