...
/**
 * Provides the local service interface for LEOTraining. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see LEOTrainingLocalServiceUtil
...
public interface LEOTrainingLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LEOTrainingLocalServiceUtil} to access the l e o training local service. Add custom service methods to {@link com.justonetech.cyzt.leo.service.impl.LEOTrainingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
