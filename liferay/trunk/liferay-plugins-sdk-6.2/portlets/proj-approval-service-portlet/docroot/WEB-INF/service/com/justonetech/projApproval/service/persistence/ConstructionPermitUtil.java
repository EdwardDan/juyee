...
/**
 * The persistence utility for the construction permit service. This utility wraps {@link ConstructionPermitPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ConstructionPermitUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ConstructionPermit constructionPermit) {
		getPersistence().clearCache(constructionPermit);
	}
	 ...
	 */
	public static List<ConstructionPermit> findWithDynamicQuery(
	 ...
	 */
	public static ConstructionPermit update(
		ConstructionPermit constructionPermit) throws SystemException {
		return getPersistence().update(constructionPermit);
	}
	 ...
	 */
	public static ConstructionPermit update(
		ConstructionPermit constructionPermit, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(constructionPermit, serviceContext);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit findByUserId_First(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit fetchByUserId_First(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit findByUserId_Last(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.justonetech.projApproval.NoSuchConstructionPermitException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit fetchByUserId_Last(
		long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit[] findByUserId_PrevAndNext(
		long constructionPermitId, long userId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.justonetech.projApproval.NoSuchConstructionPermitException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByUserId_PrevAndNext(constructionPermitId, userId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(constructionPermit);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(constructionPermits);
	}
	...
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit create(
		long constructionPermitId) {
		return getPersistence().create(constructionPermitId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit remove(
		long constructionPermitId)
		throws com.justonetech.projApproval.NoSuchConstructionPermitException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().remove(constructionPermitId);
	}

	public static com.justonetech.projApproval.model.ConstructionPermit updateImpl(
		com.justonetech.projApproval.model.ConstructionPermit constructionPermit)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(constructionPermit);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit findByPrimaryKey(
		long constructionPermitId)
		throws com.justonetech.projApproval.NoSuchConstructionPermitException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().findByPrimaryKey(constructionPermitId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.projApproval.model.ConstructionPermit fetchByPrimaryKey(
		long constructionPermitId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(constructionPermitId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.justonetech.projApproval.model.ConstructionPermit> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ConstructionPermitPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ConstructionPermitPersistence)PortletBeanLocatorUtil.locate(com.justonetech.projApproval.service.ClpSerializer.getServletContextName(),
					ConstructionPermitPersistence.class.getName());

			ReferenceRegistry.registerReference(ConstructionPermitUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(ConstructionPermitPersistence persistence) {
	}

	private static ConstructionPermitPersistence _persistence;
}