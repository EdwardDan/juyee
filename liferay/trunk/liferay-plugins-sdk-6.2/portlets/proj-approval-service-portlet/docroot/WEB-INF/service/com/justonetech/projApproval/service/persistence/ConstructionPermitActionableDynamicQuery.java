 ...
 * @generated
 */
public abstract class ConstructionPermitActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ConstructionPermitActionableDynamicQuery() throws SystemException {
		setBaseLocalService(ConstructionPermitLocalServiceUtil.getService());
		setClass(ConstructionPermit.class);

		setClassLoader(com.justonetech.projApproval.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("constructionPermitId");
	}
}