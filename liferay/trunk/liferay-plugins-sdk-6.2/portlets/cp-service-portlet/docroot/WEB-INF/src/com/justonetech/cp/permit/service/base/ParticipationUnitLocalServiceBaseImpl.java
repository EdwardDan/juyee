...
import com.justonetech.cp.permit.service.ParticipationUnitLocalService;
...
/**
 * Provides the base implementation for the participation unit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.justonetech.cp.permit.service.impl.ParticipationUnitLocalServiceImpl}.
 * </p>
 *
 * @author fanqi
 ...
 * @generated
 */
public abstract class ParticipationUnitLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ParticipationUnitLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.justonetech.cp.permit.service.ParticipationUnitLocalServiceUtil} to access the participation unit local service.
	 */
	...
	@Override
	public ParticipationUnit addParticipationUnit(
		ParticipationUnit participationUnit) throws SystemException {
		participationUnit.setNew(true);

		return participationUnitPersistence.update(participationUnit);
	}
	 ...
	 */
	@Override
	public ParticipationUnit createParticipationUnit(long unitId) {
		return participationUnitPersistence.create(unitId);
	}
	...
	@Override
	public ParticipationUnit deleteParticipationUnit(long unitId)
		throws PortalException, SystemException {
		return participationUnitPersistence.remove(unitId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ParticipationUnit deleteParticipationUnit(
		ParticipationUnit participationUnit) throws SystemException {
		return participationUnitPersistence.remove(participationUnit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ParticipationUnit.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return participationUnitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return participationUnitPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ParticipationUnit fetchParticipationUnit(long unitId)
		throws SystemException {
		return participationUnitPersistence.fetchByPrimaryKey(unitId);
	}
	 ...
	 */
	@Override
	public ParticipationUnit getParticipationUnit(long unitId)
		throws PortalException, SystemException {
		return participationUnitPersistence.findByPrimaryKey(unitId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return participationUnitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ParticipationUnit> getParticipationUnits(int start, int end)
		throws SystemException {
		return participationUnitPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getParticipationUnitsCount() throws SystemException {
		return participationUnitPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ParticipationUnit updateParticipationUnit(
		ParticipationUnit participationUnit) throws SystemException {
		return participationUnitPersistence.update(participationUnit);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.justonetech.cp.permit.model.ParticipationUnit",
			participationUnitLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = participationUnitPersistence.getDataSource();
	...
	private ParticipationUnitLocalServiceClpInvoker _clpInvoker = new ParticipationUnitLocalServiceClpInvoker();
}