...
public class ProjectProfileModelImpl extends BaseModelImpl<ProjectProfile>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "qlsl", Types.INTEGER },
			{ "qlkd", Types.VARCHAR },
			{ "guijiaosl", Types.INTEGER },
			{ "sdsl", Types.INTEGER },
			{ "gaojiasl", Types.INTEGER },
			{ "zgj", Types.VARCHAR },
			{ "zsqxks", Types.TIMESTAMP },
			{ "zsqxjs", Types.TIMESTAMP },
			{ "cnsx", Types.VARCHAR },
			{ "tzly", Types.VARCHAR },
	...
	public Object clone() {
		...
		projectProfileImpl.setBimsj(getBimsj());
		projectProfileImpl.setBimsg(getBimsg());
		projectProfileImpl.setBimyw(getBimyw());
		projectProfileImpl.setTjsj(getTjsj());
		projectProfileImpl.setGcnr(getGcnr());
		projectProfileImpl.setSgxkzsbz(getSgxkzsbz());
		projectProfileImpl.setGls(getGls());
		projectProfileImpl.setJzmj(getJzmj());
		projectProfileImpl.setQlsl(getQlsl());
		projectProfileImpl.setQlkd(getQlkd());
		projectProfileImpl.setGuijiaosl(getGuijiaosl());
		projectProfileImpl.setSdsl(getSdsl());
		projectProfileImpl.setGaojiasl(getGaojiasl());
		projectProfileImpl.setZgj(getZgj());
		projectProfileImpl.setZsqxks(getZsqxks());
		projectProfileImpl.setZsqxjs(getZsqxjs());
		projectProfileImpl.setCnsx(getCnsx());
	...
	public CacheModel<ProjectProfile> toCacheModel() {
		...
		projectProfileCacheModel.bimsj = getBimsj();

		String bimsj = projectProfileCacheModel.bimsj;

		if ((bimsj != null) && (bimsj.length() == 0)) {
			projectProfileCacheModel.bimsj = null;
		}

		projectProfileCacheModel.bimsg = getBimsg();

		String bimsg = projectProfileCacheModel.bimsg;

		if ((bimsg != null) && (bimsg.length() == 0)) {
			projectProfileCacheModel.bimsg = null;
		}

		projectProfileCacheModel.bimyw = getBimyw();

		String bimyw = projectProfileCacheModel.bimyw;

		if ((bimyw != null) && (bimyw.length() == 0)) {
			projectProfileCacheModel.bimyw = null;
		}
		...
		projectProfileCacheModel.gls = getGls();

		String gls = projectProfileCacheModel.gls;

		if ((gls != null) && (gls.length() == 0)) {
			projectProfileCacheModel.gls = null;
		}

		projectProfileCacheModel.jzmj = getJzmj();

		String jzmj = projectProfileCacheModel.jzmj;

		if ((jzmj != null) && (jzmj.length() == 0)) {
			projectProfileCacheModel.jzmj = null;
		}

		projectProfileCacheModel.qlsl = getQlsl();

		projectProfileCacheModel.qlkd = getQlkd();

		String qlkd = projectProfileCacheModel.qlkd;

		if ((qlkd != null) && (qlkd.length() == 0)) {
			projectProfileCacheModel.qlkd = null;
		}

		projectProfileCacheModel.guijiaosl = getGuijiaosl();

		projectProfileCacheModel.sdsl = getSdsl();

		projectProfileCacheModel.gaojiasl = getGaojiasl();

		projectProfileCacheModel.zgj = getZgj();

		String zgj = projectProfileCacheModel.zgj;

		if ((zgj != null) && (zgj.length() == 0)) {
			projectProfileCacheModel.zgj = null;
		}

		Date zsqxks = getZsqxks();

		if (zsqxks != null) {
			projectProfileCacheModel.zsqxks = zsqxks.getTime();
		}
		else {
			projectProfileCacheModel.zsqxks = Long.MIN_VALUE;
		}

		Date zsqxjs = getZsqxjs();

		if (zsqxjs != null) {
			projectProfileCacheModel.zsqxjs = zsqxjs.getTime();
		}
		else {
			projectProfileCacheModel.zsqxjs = Long.MIN_VALUE;
		}

		projectProfileCacheModel.cnsx = getCnsx();

		String cnsx = projectProfileCacheModel.cnsx;

		if ((cnsx != null) && (cnsx.length() == 0)) {
			projectProfileCacheModel.cnsx = null;
		}
