...
import com.justonetech.cp.permit.service.ApplyMaterialLocalService;
...
/**
 * Provides the base implementation for the apply material local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.justonetech.cp.permit.service.impl.ApplyMaterialLocalServiceImpl}.
 * </p>
 *
 * @author fanqi
 ...
 * @generated
 */
public abstract class ApplyMaterialLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ApplyMaterialLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.justonetech.cp.permit.service.ApplyMaterialLocalServiceUtil} to access the apply material local service.
	 */
	...
	@Override
	public ApplyMaterial addApplyMaterial(ApplyMaterial applyMaterial)
		throws SystemException {
		applyMaterial.setNew(true);

		return applyMaterialPersistence.update(applyMaterial);
	}
	 ...
	 */
	@Override
	public ApplyMaterial createApplyMaterial(long materialId) {
		return applyMaterialPersistence.create(materialId);
	}
	...
	@Override
	public ApplyMaterial deleteApplyMaterial(long materialId)
		throws PortalException, SystemException {
		return applyMaterialPersistence.remove(materialId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ApplyMaterial deleteApplyMaterial(ApplyMaterial applyMaterial)
		throws SystemException {
		return applyMaterialPersistence.remove(applyMaterial);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ApplyMaterial.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return applyMaterialPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return applyMaterialPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ApplyMaterial fetchApplyMaterial(long materialId)
		throws SystemException {
		return applyMaterialPersistence.fetchByPrimaryKey(materialId);
	}
	 ...
	 */
	@Override
	public ApplyMaterial getApplyMaterial(long materialId)
		throws PortalException, SystemException {
		return applyMaterialPersistence.findByPrimaryKey(materialId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return applyMaterialPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ApplyMaterial> getApplyMaterials(int start, int end)
		throws SystemException {
		return applyMaterialPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getApplyMaterialsCount() throws SystemException {
		return applyMaterialPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ApplyMaterial updateApplyMaterial(ApplyMaterial applyMaterial)
		throws SystemException {
		return applyMaterialPersistence.update(applyMaterial);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.justonetech.cp.permit.model.ApplyMaterial",
			applyMaterialLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = applyMaterialPersistence.getDataSource();
	...
	private ApplyMaterialLocalServiceClpInvoker _clpInvoker = new ApplyMaterialLocalServiceClpInvoker();
}