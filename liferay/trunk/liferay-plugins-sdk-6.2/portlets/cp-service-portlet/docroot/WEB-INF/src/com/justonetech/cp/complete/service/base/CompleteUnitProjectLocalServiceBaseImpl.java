...
import com.justonetech.cp.complete.service.CompleteUnitProjectLocalService;
...
/**
 * Provides the base implementation for the complete unit project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.justonetech.cp.complete.service.impl.CompleteUnitProjectLocalServiceImpl}.
 * </p>
 *
 * @author fanqi
 ...
 * @generated
 */
public abstract class CompleteUnitProjectLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements CompleteUnitProjectLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.justonetech.cp.complete.service.CompleteUnitProjectLocalServiceUtil} to access the complete unit project local service.
	 */
	...
	@Override
	public CompleteUnitProject addCompleteUnitProject(
		CompleteUnitProject completeUnitProject) throws SystemException {
		completeUnitProject.setNew(true);

		return completeUnitProjectPersistence.update(completeUnitProject);
	}
	 ...
	 */
	@Override
	public CompleteUnitProject createCompleteUnitProject(long projectId) {
		return completeUnitProjectPersistence.create(projectId);
	}
	...
	@Override
	public CompleteUnitProject deleteCompleteUnitProject(long projectId)
		throws PortalException, SystemException {
		return completeUnitProjectPersistence.remove(projectId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CompleteUnitProject deleteCompleteUnitProject(
		CompleteUnitProject completeUnitProject) throws SystemException {
		return completeUnitProjectPersistence.remove(completeUnitProject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(CompleteUnitProject.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return completeUnitProjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return completeUnitProjectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public CompleteUnitProject fetchCompleteUnitProject(long projectId)
		throws SystemException {
		return completeUnitProjectPersistence.fetchByPrimaryKey(projectId);
	}
	 ...
	 */
	@Override
	public CompleteUnitProject getCompleteUnitProject(long projectId)
		throws PortalException, SystemException {
		return completeUnitProjectPersistence.findByPrimaryKey(projectId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return completeUnitProjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<CompleteUnitProject> getCompleteUnitProjects(int start, int end)
		throws SystemException {
		return completeUnitProjectPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getCompleteUnitProjectsCount() throws SystemException {
		return completeUnitProjectPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public CompleteUnitProject updateCompleteUnitProject(
		CompleteUnitProject completeUnitProject) throws SystemException {
		return completeUnitProjectPersistence.update(completeUnitProject);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.justonetech.cp.complete.model.CompleteUnitProject",
			completeUnitProjectLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = completeUnitProjectPersistence.getDataSource();
	...
	private CompleteUnitProjectLocalServiceClpInvoker _clpInvoker = new CompleteUnitProjectLocalServiceClpInvoker();
}