...
public class ProjectProfilePersistenceImpl extends BasePersistenceImpl<ProjectProfile>
	...
	protected ProjectProfile toUnwrappedModel(ProjectProfile projectProfile) {
		...
		projectProfileImpl.setBimsj(projectProfile.getBimsj());
		projectProfileImpl.setBimsg(projectProfile.getBimsg());
		projectProfileImpl.setBimyw(projectProfile.getBimyw());
		...
		projectProfileImpl.setGls(projectProfile.getGls());
		projectProfileImpl.setJzmj(projectProfile.getJzmj());
		projectProfileImpl.setQlsl(projectProfile.getQlsl());
		projectProfileImpl.setQlkd(projectProfile.getQlkd());
		projectProfileImpl.setGuijiaosl(projectProfile.getGuijiaosl());
		...
		projectProfileImpl.setZysjdw(projectProfile.getZysjdw());
		...
		projectProfileImpl.setSj_xmfzrzsbh(projectProfile.getSj_xmfzrzsbh());
		projectProfileImpl.setZyjldw(projectProfile.getZyjldw());
		...
		projectProfileImpl.setZysgdw(projectProfile.getZysgdw());
