...
import com.justonetech.cp.permit.service.UnitProjectLocalService;
...
/**
 * Provides the base implementation for the unit project local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.justonetech.cp.permit.service.impl.UnitProjectLocalServiceImpl}.
 * </p>
 *
 * @author fanqi
 ...
 * @generated
 */
public abstract class UnitProjectLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UnitProjectLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.justonetech.cp.permit.service.UnitProjectLocalServiceUtil} to access the unit project local service.
	 */
	...
	@Override
	public UnitProject addUnitProject(UnitProject unitProject)
		throws SystemException {
		unitProject.setNew(true);

		return unitProjectPersistence.update(unitProject);
	}
	 ...
	 */
	@Override
	public UnitProject createUnitProject(long projectId) {
		return unitProjectPersistence.create(projectId);
	}
	...
	@Override
	public UnitProject deleteUnitProject(long projectId)
		throws PortalException, SystemException {
		return unitProjectPersistence.remove(projectId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UnitProject deleteUnitProject(UnitProject unitProject)
		throws SystemException {
		return unitProjectPersistence.remove(unitProject);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UnitProject.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return unitProjectPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return unitProjectPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return unitProjectPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UnitProject fetchUnitProject(long projectId)
		throws SystemException {
		return unitProjectPersistence.fetchByPrimaryKey(projectId);
	}
	 ...
	 */
	@Override
	public UnitProject getUnitProject(long projectId)
		throws PortalException, SystemException {
		return unitProjectPersistence.findByPrimaryKey(projectId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return unitProjectPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UnitProject> getUnitProjects(int start, int end)
		throws SystemException {
		return unitProjectPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUnitProjectsCount() throws SystemException {
		return unitProjectPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UnitProject updateUnitProject(UnitProject unitProject)
		throws SystemException {
		return unitProjectPersistence.update(unitProject);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.justonetech.cp.permit.model.UnitProject",
			unitProjectLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = unitProjectPersistence.getDataSource();
	...
	private UnitProjectLocalServiceClpInvoker _clpInvoker = new UnitProjectLocalServiceClpInvoker();
}