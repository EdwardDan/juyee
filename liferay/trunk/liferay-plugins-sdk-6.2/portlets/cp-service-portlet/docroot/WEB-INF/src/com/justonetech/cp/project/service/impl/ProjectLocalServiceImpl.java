...
public class ProjectLocalServiceImpl extends ProjectLocalServiceBaseImpl {
	...
	public List<Project> getProjects(String zzjgdm,String bjbh, String wssqbh, String xmmc, Date bjrqStart, Date bjrqEnd, String bjwcbj, int start, int end) {

		try {
			return this.dynamicQuery(createDynamicQuery(zzjgdm,bjbh, wssqbh, xmmc, bjrqStart, bjrqEnd, bjwcbj), start, end);
		}
	...
	public int getProjectsCount(String zzjgdm,String bjbh, String wssqbh, String xmmc, Date bjrqStart, Date bjrqEnd, String bjwcbj) {

		try {
			return (int) this.dynamicQueryCount(createDynamicQuery(zzjgdm,bjbh, wssqbh, xmmc, bjrqStart, bjrqEnd, bjwcbj));
		}
		catch (SystemException e) {
			log.info(e.getMessage());
		}
	...
	public DynamicQuery createDynamicQuery(String zzjgdm,String bjbh, String wssqbh, String xmmc, Date bjrqStart, Date bjrqEnd, String bjwcbj) {
