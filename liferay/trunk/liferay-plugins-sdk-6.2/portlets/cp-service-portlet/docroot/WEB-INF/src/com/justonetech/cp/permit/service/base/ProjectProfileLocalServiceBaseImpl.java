...
import com.justonetech.cp.permit.service.ProjectProfileLocalService;
...
/**
 * Provides the base implementation for the project profile local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.justonetech.cp.permit.service.impl.ProjectProfileLocalServiceImpl}.
 * </p>
 *
 * @author fanqi
 ...
 * @generated
 */
public abstract class ProjectProfileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProjectProfileLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.justonetech.cp.permit.service.ProjectProfileLocalServiceUtil} to access the project profile local service.
	 */
	...
	@Override
	public ProjectProfile addProjectProfile(ProjectProfile projectProfile)
		throws SystemException {
		projectProfile.setNew(true);

		return projectProfilePersistence.update(projectProfile);
	}
	 ...
	 */
	@Override
	public ProjectProfile createProjectProfile(long permitId) {
		return projectProfilePersistence.create(permitId);
	}
	...
	@Override
	public ProjectProfile deleteProjectProfile(long permitId)
		throws PortalException, SystemException {
		return projectProfilePersistence.remove(permitId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public ProjectProfile deleteProjectProfile(ProjectProfile projectProfile)
		throws SystemException {
		return projectProfilePersistence.remove(projectProfile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProjectProfile.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return projectProfilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return projectProfilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public ProjectProfile fetchProjectProfile(long permitId)
		throws SystemException {
		return projectProfilePersistence.fetchByPrimaryKey(permitId);
	}
	 ...
	 */
	@Override
	public ProjectProfile getProjectProfile(long permitId)
		throws PortalException, SystemException {
		return projectProfilePersistence.findByPrimaryKey(permitId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return projectProfilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<ProjectProfile> getProjectProfiles(int start, int end)
		throws SystemException {
		return projectProfilePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getProjectProfilesCount() throws SystemException {
		return projectProfilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public ProjectProfile updateProjectProfile(ProjectProfile projectProfile)
		throws SystemException {
		return projectProfilePersistence.update(projectProfile);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.justonetech.cp.permit.model.ProjectProfile",
			projectProfileLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = projectProfilePersistence.getDataSource();
	...
	private ProjectProfileLocalServiceClpInvoker _clpInvoker = new ProjectProfileLocalServiceClpInvoker();
}