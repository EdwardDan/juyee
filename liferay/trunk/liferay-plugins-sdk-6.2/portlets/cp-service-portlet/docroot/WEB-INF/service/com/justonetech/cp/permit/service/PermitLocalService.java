...
/**
 * Provides the local service interface for Permit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see PermitLocalServiceUtil
...
public interface PermitLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link PermitLocalServiceUtil} to access the permit local service. Add custom service methods to {@link com.justonetech.cp.permit.service.impl.PermitLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
