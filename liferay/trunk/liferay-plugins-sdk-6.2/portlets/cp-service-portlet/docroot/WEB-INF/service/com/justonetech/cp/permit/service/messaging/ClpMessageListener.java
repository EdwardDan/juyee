...
package com.justonetech.cp.permit.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			ApplyMaterialLocalServiceUtil.clearService();

			ParticipationUnitLocalServiceUtil.clearService();

			PermitLocalServiceUtil.clearService();

			ProjectProfileLocalServiceUtil.clearService();

			UnitProjectLocalServiceUtil.clearService();
		}
	}
}