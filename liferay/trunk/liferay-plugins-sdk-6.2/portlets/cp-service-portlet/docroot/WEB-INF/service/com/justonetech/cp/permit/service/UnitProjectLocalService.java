...
/**
 * Provides the local service interface for UnitProject. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see UnitProjectLocalServiceUtil
...
public interface UnitProjectLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UnitProjectLocalServiceUtil} to access the unit project local service. Add custom service methods to {@link com.justonetech.cp.permit.service.impl.UnitProjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
