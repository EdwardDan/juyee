...
/**
 * The persistence utility for the complete unit project service. This utility wraps {@link CompleteUnitProjectPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class CompleteUnitProjectUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(CompleteUnitProject completeUnitProject) {
		getPersistence().clearCache(completeUnitProject);
	}
	 ...
	 */
	public static List<CompleteUnitProject> findWithDynamicQuery(
	 ...
	 */
	public static CompleteUnitProject update(
		CompleteUnitProject completeUnitProject) throws SystemException {
		return getPersistence().update(completeUnitProject);
	}
	 ...
	 */
	public static CompleteUnitProject update(
		CompleteUnitProject completeUnitProject, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(completeUnitProject, serviceContext);
	}
	...
	*/
	public static java.util.List<com.justonetech.cp.complete.model.CompleteUnitProject> findByCompleteId(
		long completeId)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject findByCompleteId_First(
		long completeId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject fetchByCompleteId_First(
		long completeId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject findByCompleteId_Last(
		long completeId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.justonetech.cp.complete.NoSuchCompleteUnitProjectException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject fetchByCompleteId_Last(
		long completeId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject[] findByCompleteId_PrevAndNext(
		long projectId, long completeId,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.justonetech.cp.complete.NoSuchCompleteUnitProjectException,
			com.liferay.portal.kernel.exception.SystemException {
		return getPersistence()
				   .findByCompleteId_PrevAndNext(projectId, completeId,
			orderByComparator);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(completeUnitProject);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(completeUnitProjects);
	}
	...
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject create(
		long projectId) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject remove(
		long projectId)
		throws com.justonetech.cp.complete.NoSuchCompleteUnitProjectException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	public static com.justonetech.cp.complete.model.CompleteUnitProject updateImpl(
		com.justonetech.cp.complete.model.CompleteUnitProject completeUnitProject)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(completeUnitProject);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject findByPrimaryKey(
		long projectId)
		throws com.justonetech.cp.complete.NoSuchCompleteUnitProjectException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.justonetech.cp.complete.model.CompleteUnitProject fetchByPrimaryKey(
		long projectId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.justonetech.cp.complete.model.CompleteUnitProject> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CompleteUnitProjectPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (CompleteUnitProjectPersistence)PortletBeanLocatorUtil.locate(com.justonetech.cp.complete.service.ClpSerializer.getServletContextName(),
					CompleteUnitProjectPersistence.class.getName());

			ReferenceRegistry.registerReference(CompleteUnitProjectUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(CompleteUnitProjectPersistence persistence) {
	}

	private static CompleteUnitProjectPersistence _persistence;
}