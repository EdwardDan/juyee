...
/**
 * Provides the local service interface for CompleteProjectProfile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see CompleteProjectProfileLocalServiceUtil
...
public interface CompleteProjectProfileLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompleteProjectProfileLocalServiceUtil} to access the complete project profile local service. Add custom service methods to {@link com.justonetech.cp.complete.service.impl.CompleteProjectProfileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
