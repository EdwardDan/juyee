...
/**
 * Provides the local service interface for CompleteApplyMaterial. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author fanqi
 * @see CompleteApplyMaterialLocalServiceUtil
...
public interface CompleteApplyMaterialLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompleteApplyMaterialLocalServiceUtil} to access the complete apply material local service. Add custom service methods to {@link com.justonetech.cp.complete.service.impl.CompleteApplyMaterialLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
