...
import com.justonetech.xmq.project.model.ProjectClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"xmq-service-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "xmq-service-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.justonetech.xmq.project.model.impl.ProjectImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.justonetech.xmq.project.NoSuchProjectException")) {
			return new com.justonetech.xmq.project.NoSuchProjectException();
		}
