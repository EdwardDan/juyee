...
import com.justonetech.portal.feedback.model.FeedbackClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"portal-service-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "portal-service-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.justonetech.portal.feedback.model.impl.FeedbackImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.justonetech.portal.feedback.NoSuchFeedbackException")) {
			return new com.justonetech.portal.feedback.NoSuchFeedbackException();
		}
