...
<%
	...
	Complete complete = CompleteLocalServiceUtil
			.getComplete(completeId);
	...
	List<Dictionary> jsgclbs = jsgclb != null ? DictionaryLocalServiceUtil
			.findByParentId(jsgclb.getDictionaryId(), -1, -1) : null;
	request.setAttribute("complete", complete);
	request.setAttribute("completeProjectProfile",
...
<table class="table table-bordered" width="100%">
	<tr class="body">
		...
		<td class="bg-white"><%=DictionaryLocalServiceUtil.getDictionary(
					completeProjectProfile.getXmlx()).getName()%></td>
		<td class="text-right">建设工程属性</td>
		<td class="bg-white"><%=DictionaryLocalServiceUtil.getDictionary(
					completeProjectProfile.getJsgcsx()).getName()%></td>
	</tr>
	<tr class="body">
		<td class="text-right">立项级别</td>
		<td class="bg-white">${completeProjectProfile.lxjb}</td>
	...
	<tr>
		...
		<td class="bg-white" colspan="3">${completeProjectProfile.jsdd}</td>
	</tr>
	<tr class="body">
