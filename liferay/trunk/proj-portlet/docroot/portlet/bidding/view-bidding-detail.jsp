...
<%	
	...
	List<Dictionary> involveCountys = involveCountyDic != null ? DictionaryLocalServiceUtil.findByParentId(involveCountyDic.getDictionaryId(), -1, -1) : null;
		...
		<aui:row>
			...
			<aui:col span="6" cssClass="text-left">
				...
				<input type="text" class="field" name="<portlet:namespace/>startDate" id="startDate"
					onfocus="WdatePicker({lang:'zh-cn'})" required="required" disabled="true"
