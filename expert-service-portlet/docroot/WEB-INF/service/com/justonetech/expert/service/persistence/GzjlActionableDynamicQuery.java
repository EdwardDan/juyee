 ...
 * @generated
 */
public abstract class GzjlActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public GzjlActionableDynamicQuery() throws SystemException {
		setBaseLocalService(GzjlLocalServiceUtil.getService());
		setClass(Gzjl.class);

		setClassLoader(com.justonetech.expert.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("GzjlId");
	}
}