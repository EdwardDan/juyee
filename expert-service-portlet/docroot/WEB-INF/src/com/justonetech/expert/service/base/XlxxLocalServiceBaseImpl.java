...
import com.justonetech.expert.service.XlxxLocalService;
...
/**
 * Provides the base implementation for the xlxx local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.justonetech.expert.service.impl.XlxxLocalServiceImpl}.
 * </p>
 *
 * @author fanqi
 ...
 * @generated
 */
public abstract class XlxxLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements XlxxLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.justonetech.expert.service.XlxxLocalServiceUtil} to access the xlxx local service.
	 */
	...
	@Override
	public Xlxx addXlxx(Xlxx xlxx) throws SystemException {
		xlxx.setNew(true);

		return xlxxPersistence.update(xlxx);
	}
	 ...
	 */
	@Override
	public Xlxx createXlxx(long xlxxId) {
		return xlxxPersistence.create(xlxxId);
	}
	...
	@Override
	public Xlxx deleteXlxx(long xlxxId) throws PortalException, SystemException {
		return xlxxPersistence.remove(xlxxId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Xlxx deleteXlxx(Xlxx xlxx) throws SystemException {
		return xlxxPersistence.remove(xlxx);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Xlxx.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return xlxxPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return xlxxPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return xlxxPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return xlxxPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Xlxx fetchXlxx(long xlxxId) throws SystemException {
		return xlxxPersistence.fetchByPrimaryKey(xlxxId);
	}
	 ...
	 */
	@Override
	public Xlxx getXlxx(long xlxxId) throws PortalException, SystemException {
		return xlxxPersistence.findByPrimaryKey(xlxxId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return xlxxPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Xlxx> getXlxxs(int start, int end) throws SystemException {
		return xlxxPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getXlxxsCount() throws SystemException {
		return xlxxPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Xlxx updateXlxx(Xlxx xlxx) throws SystemException {
		return xlxxPersistence.update(xlxx);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.justonetech.expert.model.Xlxx",
			xlxxLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = xlxxPersistence.getDataSource();
	...
	private XlxxLocalServiceClpInvoker _clpInvoker = new XlxxLocalServiceClpInvoker();
}