...
TheSameName : "已有同名文件，建议重命名为：",
InvalidFileType : "无效的文件格式！",
SecurityError : "操作失败，你可能没有上传权限！",
ConnectorDisabled : "连接器被禁用！",
ErrorOnFileUpload : "上传文件时发生错误. 错误编码是：",
WarnSelectFile : "请选择要上传的文件！",
