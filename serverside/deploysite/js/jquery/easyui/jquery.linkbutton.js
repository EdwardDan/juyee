...
(function ($) {
    ...
    function createButton(target) {
        ...
        $(target).css("text-decoration", "none").empty();

        var defaultCls = opts.defaultButtonCls[opts.text];
        defaultCls = opts.userCls || defaultCls;
        if (defaultCls) {
            var btn = $("<input type='button' name='button'/>");
            btn.attr({
                'class':defaultCls,
                'value':opts.text
            });
