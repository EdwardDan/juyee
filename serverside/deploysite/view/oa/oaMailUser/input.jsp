...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var validateCondition = [
                                                                        //{name:"typeCode", rule:"validate[required,custom[integer],maxSize[2]"},            
                                                                                                      //{name:"userName", rule:"validate[required,maxSize[50]]"},            
                                                                                                      //{name:"isRead", rule:"validate[required,maxSize[1]]"},            
                                                                                                      //{name:"readTime", rule:"validate[required,maxSize[7]]"},            
                                                                                                      //{name:"isDelete", rule:"validate[required,maxSize[1]]"},            
                                                                                                      //{name:"deleteTime", rule:"validate[required,maxSize[7]]"},            
...
//        }
        ...
        //提交表单
        saveAjaxData("${ctx}/oaMailUser/save.do", formId);
    }
</script>
<form:form commandName="bean">
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
              ...
              <td class="form_content">
                        <form:input path="userName" cssClass="input_text"/>						
                          </td>                                
            </tr>
                                    <tr class="tr_light">
              <td class="form_label">是否已阅：</td>
              <td class="form_content">
                                    <form:checkbox path="isRead" value="1"/>
                                      </td>                                
            </tr>
                                                <tr class="tr_dark">
              <td class="form_label">阅读时间：</td>
              <td class="form_content">
                                <input type="text" name="readTime" id="readTime" class="input_datetime"
                           value="<fmt:formatDate value="${bean.readTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly="true"/>
                    <input type="button" class="button_calendar" value=" " onClick="calendar('readTime','all')">                                                        
              ...
              <td class="form_content">
                                <input type="text" name="deleteTime" id="deleteTime" class="input_datetime"
                           value="<fmt:formatDate value="${bean.deleteTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" readonly="true"/>
                    <input type="button" class="button_calendar" value=" " onClick="calendar('deleteTime','all')">                                                        
