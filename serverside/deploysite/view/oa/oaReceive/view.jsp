    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table" style="border-collapse: collapse;">
            ...
            <tr class="tr_dark">
                ...
                <td class="td_border" align="left">&nbsp;<fmt:formatDate value="${bean.limitDate}" pattern="yyyy-MM-dd HH:mm"/></td>
            </tr>
            <tr class="tr_light">
            ...
            <tr class="tr_light">
                ...
                <td class="td_border" align="left" width="23%">&nbsp; <fmt:formatDate value="${bean.receiveDate}" pattern="yyyy-MM-dd HH:mm"/> </td>
                <td class="td_border" align="right" width="10%">成文日期：</td>
                <td class="td_border" align="left" width="23%">&nbsp;<fmt:formatDate value="${bean.writtenDate}" pattern="yyyy-MM-dd HH:mm"/></td>
            ...
            <tr class="tr_light" style="height: 80px">
                ...
                <td class="td_border" align="left" colspan="5"> <div class="form_div_left" style="min-height: 80px">
