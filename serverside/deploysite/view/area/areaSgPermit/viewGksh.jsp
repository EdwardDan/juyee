...
<script type="text/javascript">
    ...
    function printView5() {
        window.open("${ctx}/areaSgPermit/printView5.do?id=${bean.id}", "不予许可通知书", "status=no,toolbar=no,menubar=no,scrollbars=yes,resizable=yes,width=800,hight=600;");
    }
    function printExcel1() {
        window.open("${ctx}/areaSgPermit/printExcel1.do?id=${bean.id}");
    }
    function printExcel2() {
        window.open("${ctx}/areaSgPermit/printExcel2.do?id=${bean.id}");
    }
</script>
<div class="form_div">
