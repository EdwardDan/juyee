        ...
        var conf = {
            gridOpts: {
                ...
                colModel: [
                    ...
                    {name: "no", width: "30", align: "center", searchtype: "integer", sortable: true, hidden: true},
                    {name: "projNum", width: "30", align: "center", searchtype: "integer", sortable: true, hidden: true},
