...
<form:form commandName="bean">
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
            ...
            <tr>
                <td colspan="4">
                    <table cellpadding="0" cellspacing="0" class="table_thin_line" name="testInfo" id="testInfo"
                        ...
                        <c:forEach items="${serviceReturnItems}" var="serviceReturnItem" varStatus="status">
                            <tr class="tr_light">
                                ...
                                <td style="text-align: center;width: 15%">
                                    <sys:code code="${SERVICE_BOOK_TYPE}" name="serviceBook" type="select"
                                              defaultName=""
                                              style="width: 95%"
                                ...
                                <td style="text-align: center;width: 15%">
                                    <input type="text" name="receiveDate" id="autoReceiveDate${status.index+1}"
                                           ...
                                           onclick="calendar('autoReceiveDate${status.index+1}','date')"/>
                                </td>
                                <td style="text-align: center;width: 15%">
            ...
            <tr style="display: none" id="standTr"><%--标准行--%>
                ...
                <td style="width: 15%">
                    <input type="text" class="input_text" name="standTr_servicePersonSub" id="autoServicePerson"
                           style="width: 95%"/>
                </td>
                <td style="width: 15%">
