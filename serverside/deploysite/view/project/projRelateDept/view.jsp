    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
            <tr class="tr_light">
                ...
                <td class="form_content">${bean.category.name}
                </td>
            </tr>
            <tr class="tr_dark">
                ...
                <td class="form_content"><c:choose><c:when
                        test="${bean.manager == null}">暂无</c:when><c:otherwise>${bean.manager}</c:otherwise></c:choose>
                </td>
            </tr>
            <tr class="tr_light">
            ...
            <tr class="tr_dark">
                ...
                <td class="form_label_right">
                    公司电话:&nbsp;</td>
                <td class="form_content"><c:choose><c:when
                        test="${bean.tel == null}">暂无</c:when><c:otherwise>${bean.tel}</c:otherwise></c:choose>
                </td>
            </tr>
            <tr class="tr_light">
