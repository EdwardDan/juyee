...
//            document.bean.submit();
            ...
            loadAjaxData("check", "${ctx}/bpmProjectGroupDuty/extAttrCheck.do?id=" + id + "&defCode=&attributeType=" + attributeType + "&expression=");
        }

        function setExtAttr() {
            var id = document.getElementById("beanid").value;
            var url = "?id=" + id;
            openWindow("岗位扩展属性设置", "${ctx}/bpmProjectGroupDuty/setExtAttr.do" + url, true, 800, 500);
        }
        function save(btn) {
            var formId = "bean";
            saveAjaxData("${ctx}/bpmProjectGroupDuty/saveExtAttr.do", formId);
        }
    </script>
</head>
...
<form:form commandName="bean" id="bean" method="post">
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" >
        ...
        <tr>
            <td class="tr_title" colspan="3" height="30px">
                <!-- title begin -->
                岗位扩展属性设置
                <!-- title begin -->
            </td>
