...
//        }
            ...
            saveAjaxData("${ctx}/bpmProjectGroup/saveExtAttrSetting.do", formId);
        <%--window.location.href="${ctx}/bpmProjectGroup/eextAttr.do?id=" + id+ "&defCode=&attributeType=&expression=";--%>
