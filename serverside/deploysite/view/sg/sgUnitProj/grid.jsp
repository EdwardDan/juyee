...
<script type="text/javascript">
    $(function () {
        var conf = {
            gridOpts:{
                url:"${ctx}/sgUnitProj/gridDataCustom.do",
                colNames:['ID',
            	'序号',            	          	
            	'单位工程编号',            	          	
            	'单位工程名称',            	          	
...
{name:"num",width:"100",align:"center",searchtype:"integer",sortable:true,formatter:'integer',formatoptions:{thousandsSeparator:",",defaulValue:0}},
{name:"unitProjCode",width:"100",align:"center",searchtype:"string",sortable:true},
{name:"unitProjName",width:"100",align:"center",searchtype:"string",sortable:true},
{name:"unitPhone",width:"100",align:"center",searchtype:"string",sortable:true},
...
{name:"updateUser",width:"100",align:"center",searchtype:"string",sortable:true}
    ...
    function doView(id) {
        openWindow("查看单位工程列表", "${ctx}/sgUnitProj/view.do?id=" + id, false);
    }
    <c:if test="${canEdit}">
    function doAdd() {
        openWindow("添加单位工程列表", "${ctx}/sgUnitProj/add.do", true);
    }
    function doEdit(id) {
        openWindow("修改单位工程列表", "${ctx}/sgUnitProj/modify.do?id=" + id, true);
    }    
    function doDelete(id) {
        doGridDelete("${ctx}/sgUnitProj/delete.do?id=" + id);
    }
    </c:if>
