...
<script src="${ctx}/js/jquery/ui/jquery.elastic.source.js" type="text/javascript"></script>
...
<%--&lt;%&ndash;<script src="${ctx}/js/jquery/jo/jquery.JOWindow.js" type="text/javascript"></script>&ndash;%&gt;--%>
<%--&lt;%&ndash;<script src="${ctx}/js/jquery/jquery-calendar.js" type="text/javascript"></script>&ndash;%&gt;--%>
...
<%--/******************************以下为自行添加内容****************************************/--%>
<%--<script src="${ctx}/js/jquery/easyui/jquery-1.4.4.min.js" type="text/javascript"></script>--%>
...
<script src="${ctx}/js/jquery/jquery.timer.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery/jquery.parser.js" type="text/javascript"></script>
<script src="${ctx}/js/default.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery/jo/Jo.jqFilter.js" type="text/javascript"></script>
<script src="${ctx}/js/jquery/jo/Jo.jqGrid.js" type="text/javascript"></script>
