...
<script type="text/javascript">
    $(function () {
        var conf = {
            gridOpts:{
                url:"${ctx}/projectQuery/gridDataCustomAJ.do?flag=${flag}",
...
//                    ,'项目进度'
                ...
                colModel:[
                    ...
                    {name:'t.jd_task_code', width:30, align:"center", searchtype:"string",sortable:true,hidden:true},
                    ...
                    {name:'t.property', width:30, align:"center", searchtype:"string",sortable:true<c:if test="${flag==FLAG_BJ}">,hidden:true</c:if>},
        ...
        {name:'t.BELONG_AREA', width:35, align:"right", searchtype:"integer",sortable:true,formatter:'currency',formatoptions:{decimalSeparator:".", thousandsSeparator: ",",
