                    ...
                    if (canEdit) {
                        if (treeNode.id == 'root') {
                            ...
                            menu.push(["上移", function(treeNode, zTree) {
                                treeActions.moveUp(treeNode, zTree, clazzDetail,"sys_code_id="+treeNode.getParentNode().id);
                            }]);
                            menu.push(["下移", function(treeNode, zTree) {
                                treeActions.moveDown(treeNode, zTree, clazzDetail,"sys_code_id="+treeNode.getParentNode().id);
                            }]);
                        }
                        menu.push([]);
                    }
