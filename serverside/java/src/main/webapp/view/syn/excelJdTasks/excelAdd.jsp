...
<div class="form_div">
    <form name="uploadForm" method="post" action="${ctx}/excelJdTasks/excelSave.do" enctype="multipart/form-data" class="">


        <table cellpadding="0" cellspacing="0" style="width: 100%;" align="center" >
            <tr class="tr_light" >
                <td class="form_label_right" style="height: 200px">选择excel文件:</td>
                <td class="form_content"><input type="file" name="file" class="input_text_long"></td>
            </tr>
            <tr class="tr_button">
