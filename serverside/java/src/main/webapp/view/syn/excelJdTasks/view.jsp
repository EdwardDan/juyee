...
<div id="tabsChild" class="easyui-tabs1">
    <div title="基本信息" closable="false" cache="false"  href="${ctx}/excelJdTasks/viewTask.do?id=${id}"></div>
    <div title="单位工程" closable="false" cache="false"  href="${ctx}/excelJdTasks/viewDwgc.do?id=${id}"></div>
</div>