...
<script type="text/javascript">
    function printExcelFR() {
        printFR("ReportMonthSum", "id=${bean.id}");
    }
</script>
<div class="form_div">
    <table cellpadding="0" cellspacing="0" class="form_table">
        ...
        <tr class="tr_dark">
            <td class="form_border" align="left" colspan="2">
                &nbsp;汇总说明：1、统计周期为上月26日至本月25日。
            </td>
        </tr>
        <tr class="tr_button" align="center">
            <td class="form_border" align="center" colspan="2">
                <input type="button" id="print" value="打印" class="button_all" onclick="printExcelFR()"/>
                <input type="button" id="close" value="关闭" class="button_cancel" onclick="closeWindow()">
            </td>
        </tr>
    </table>
</div>
