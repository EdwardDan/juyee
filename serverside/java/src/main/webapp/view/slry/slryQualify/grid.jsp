...
{name:"description",width:"53",align:"center",searchtype:"string",sortable:true},
{name:"name",width:"53",align:"center",searchtype:"integer",sortable:true,formatter:'integer',formatoptions:{thousandsSeparator:",",defaulValue:0}},
{name:"sex",width:"53",align:"center",searchtype:"integer",sortable:true,formatter:booleanFormat},
{name:"birthDate",width:"53",align:"center",searchtype:"date",sortable:true},
{name:"idCard",width:"53",align:"center",searchtype:"string",sortable:true},
{name:"graduationTime",width:"53",align:"center",searchtype:"datetime",sortable:true,formatter:'date',formatoptions:{srcformat:'Y-m-d H:i:s',newformat:'Y-m-d H:i:s'}},
{name:"graduationSchool",width:"53",align:"center",searchtype:"string",sortable:true},
{name:"major",width:"53",align:"center",searchtype:"string",sortable:true},
{name:"workResume",width:"53",align:"center",searchtype:"string",sortable:true},
{name:"production",width:"53",align:"center",searchtype:"string",sortable:true},
...
{name:"updateUser",width:"53",align:"center",searchtype:"string",sortable:true}
            ...
            userOpts:{
                ...
                { "field":"毕业时间", "op":"bw", "data":""},            	    
            	{ "field":"毕业院校", "op":"cn", "data":""},            	    
            	{ "field":"所学专业", "op":"cn", "data":""},            	    
            	{ "field":"工作简历", "op":"cn", "data":""},            	    
            	{ "field":"生产业绩", "op":"cn", "data":""},            	    
