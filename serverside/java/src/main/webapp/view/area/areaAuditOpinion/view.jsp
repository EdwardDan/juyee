...
<div class="form_div">
    <table cellpadding="0" cellspacing="0" class="form_table">
          ...
          <td class="form_content">&nbsp;
                                  <c:choose><c:when test="${bean.isCsOpinion}">是</c:when><c:otherwise>否</c:otherwise></c:choose>
                                </td>
        </tr>
                        <tr class="tr_light">
          <td class="form_label">复核意见：</td>
          <td class="form_content">&nbsp;
                                  <c:choose><c:when test="${bean.isFhOpinion}">是</c:when><c:otherwise>否</c:otherwise></c:choose>
                                </td>
        </tr>
                                <tr class="tr_dark">
          <td class="form_label">审核意见：</td>
          <td class="form_content">&nbsp;
                                  <c:choose><c:when test="${bean.isShOpinion}">是</c:when><c:otherwise>否</c:otherwise></c:choose>
                                </td>
        </tr>
                        <tr class="tr_light">
