    ...
    $(function () {
        ...
        var validateCondition = [
                                                                        //{name:"no", rule:"validate[required,custom[integer],maxSize[10]"},            
                                                                                                      //{name:"isCsOpinion", rule:"validate[required,maxSize[1]]"},            
                                                                                                      //{name:"isFhOpinion", rule:"validate[required,maxSize[1]]"},            
                                                                                                      //{name:"isShOpinion", rule:"validate[required,maxSize[1]]"},            
...
//        }
        ...
        //提交表单
        saveAjaxData("${ctx}/areaAuditOpinion/save.do", formId);
    }
</script>
<form:form commandName="bean">
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
              ...
              <td class="form_content">
                                    <form:checkbox path="isCsOpinion" value="1"/>
                                      </td>                                
            </tr>
                                    <tr class="tr_light">
              <td class="form_label">复核意见：</td>
              <td class="form_content">
                                    <form:checkbox path="isFhOpinion" value="1"/>
                                      </td>                                
            </tr>
                                                <tr class="tr_dark">
              <td class="form_label">审核意见：</td>
              <td class="form_content">
                                    <form:checkbox path="isShOpinion" value="1"/>
                                      </td>                                
            </tr>
                                    <tr class="tr_light">
