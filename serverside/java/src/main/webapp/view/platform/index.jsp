...
<head id="Head1">
    ...
    <title>${projectArea}区建设工程远程监控信息系统</title>
    ...
    <script type="text/javascript">
        ...
        function loadPlatPage(type) {
            switch (type) {
                case "jdyy":
                    loadUrl(0, '${ctx}/orderFormSite/init.do');
                    break;
                case "jdxx":
                    loadUrl(1,null);
                    break;
                case "jddj":
                    loadUrl(2, '${ctx}/jdStopOrder/init.do');
                    break;
                case "cysb":
                    loadUrl(3, '${ctx}/jdCysb/grid.do');
                    break;
                case "jlbg":
                    loadUrl(4,'${ctx}/jdJlReport/grid.do');
                    break;
                case "tbbz":
                    loadUrl(5,null);
                    break;
                ...
                case "wgts":
                    ...
                    break;
                case "wgry":
                    loadUrl(8, '${ctx}/workerSchool/grid.do');
                    break;
    ...
    <div class="Left">
        <div class="line">
            ...
            <div class="kuang">
                <ul>
                    <li class="a1">
                        <a href="javascript:void(0)" onclick="loadPlatPage('jdyy')">监督预约</a>
                    </li>
                    <li class="a2">
                        <a href="javascript:void(0)" onclick="loadPlatPage('jdxx')">监督信息查询</a>
                    </li>
                    <li class="a3">
                        <a href="javascript:void(0)" onclick="loadPlatPage('jddj')" class="link_tmp">监督单据反馈</a>
                    </li>
                    <li class="a4">
                        <a href="javascript:void(0)" onclick="loadPlatPage('cysb')">创优申报</a>
                    </li>
                    <li class="a5">
                        <a href="javascript:void(0)" onclick="loadPlatPage('jlbg')">监理报告上传</a>
                    </li>
                    <li class="a6">
                        <a href="javascript:void(0)" onclick="loadPlatPage('tbbz')">投标保证金缴纳</a>
                    </li>
                    <li class="a7">
                        <a href="javascript:void(0)" onclick="loadPlatPage('xfts')">信访投诉</a>
                    </li>
                    <li class="a8">
                        <a href="javascript:void(0)" onclick="loadPlatPage('wgts')">务工投诉申请</a>
                    </li>
                    <li class="a9">
                        <a href="javascript:void(0)" onclick="loadPlatPage('wgry')">务工人员学校管理</a>
                    </li>
                </ul>
            </div>
        </div>
