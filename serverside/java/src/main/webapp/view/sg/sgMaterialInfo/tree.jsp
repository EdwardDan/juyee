        ...
        var setting = {
            simpleOpts:{
                ...
                clickOpts:{
                    ...
                    "data":["查看样例", CONTEXT_NAME + "/sgMaterialInfo/view.do?id={id}"]
                },
                rightMenuOpts:function (treeNode, zTree) {
                    var menu = [];
                    if (canEdit) {
                        menu.push(["添加", ["添加样例", CONTEXT_NAME + "/sgMaterialInfo/add.do?parentId={id}"]]);

                        if (treeNode.id != 'root') {
                            menu.push(["修改", ["修改样例", CONTEXT_NAME + "/sgMaterialInfo/modify.do?id={id}"]]);
                            menu.push([]);
