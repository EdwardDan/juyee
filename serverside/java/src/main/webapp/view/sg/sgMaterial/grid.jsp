...
<script type="text/javascript">
    $(function () {
        var conf = {
            gridOpts:{
                url:"${ctx}/sgMaterial/gridDataCustom.do",
                colNames:['ID',
            	'序号',            	          	
            	'材料齐全情况',            	          	
            	'份数',            	          	
...
{name:"no",width:"114",align:"center",searchtype:"string",sortable:true},
{name:"isFull",width:"114",align:"center",searchtype:"integer",sortable:true,formatter:booleanFormat},
{name:"num",width:"114",align:"center",searchtype:"string",sortable:true},
...
{name:"updateUser",width:"114",align:"center",searchtype:"string",sortable:true}
    ...
    function doView(id) {
        openWindow("查看施工材料", "${ctx}/sgMaterial/view.do?id=" + id, false);
    }
    <c:if test="${canEdit}">
    function doAdd() {
        openWindow("添加施工材料", "${ctx}/sgMaterial/add.do", true);
    }
    function doEdit(id) {
        openWindow("修改施工材料", "${ctx}/sgMaterial/modify.do?id=" + id, true);
    }    
    function doDelete(id) {
        doGridDelete("${ctx}/sgMaterial/delete.do?id=" + id);
    }
    </c:if>
