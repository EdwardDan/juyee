...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var validateCondition = [
            {name: "replyUsername", rule: "validate[required]"},
            {name: "receiveUsername", rule: "validate[required]"},
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
            ...
            <tr class="tr_light">
                ...
                <td class="form_content">
                    <form:input path="replyUsername" cssClass="input_text" readonly="true"/>
                    <input type="hidden" name="replyPerson" id="replyPerson" value="${bean.replyPerson}"/>
                    <input type="button" value=" " class="button_select"
                           onclick="selectSysPerson('replyPerson','replyUsername')" title="选择回复人"/>
                </td>
            </tr>
            ...
            <tr class="tr_light">
                ...
                <td class="form_content">
                    ...
                    <form:input path="receiveUsername" cssClass="input_text" readonly="true"/>
                    <input type="hidden" name="receivePerson" id="receivePerson" value="${bean.receivePerson}"/>
                    <input type="button" value=" " class="button_select"
                           onclick="selectSysPerson('receivePerson','receiveUsername')" title="选择接收人"/>
                </td>
            </tr>
            <tr class="tr_button">
