...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var validateCondition = [
            ...
            {name: "reformBeginDate", rule: "validate[required,maxSize[19]"},
    ...
    function save(status, btn) {
        var dateTime = $("#reformBeginDatePre").val()+' '+$("#hour").val()+':00:00';
        $("#reformBeginDate").val(dateTime);
        $('#status').val(status);
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
            ...
            <tr class="tr_dark">
                ...
                <td class="form_content">
                        <%--<form:input path="recheckDept" cssClass="input_text"/>--%>
            ...
            <tr class="tr_light">
                ...
                <td class="form_content">
                    <input type="text" name="reformBeginDatePre" class="input_date" id="reformBeginDatePre" value="<fmt:formatDate value="${bean.reformBeginDate}" pattern="yyyy-MM-dd"/>" />
                    <input type="button" class="button_calendar" value="" onClick="calendar('reformBeginDatePre');">
                    <select id="hour">
                        ${hourSelect}
                    </select>
                     时
                    <form:hidden path="reformBeginDate" cssClass="input_datetime" readonly="true"/>
                </td>
            </tr>
            <tr class="tr_dark">
