...
<script type="text/javascript">
    $(function () {
        var conf = {
            gridOpts:{
                url:"${ctx}/jdRecordFirst/gridDataCustom.do?code=${code}",
                colNames:['ID',
                    '选择',  //单选项
                    '监督记录编号',
                    '报建编号',
                ...
                colModel:[
                    ...
                    {name:"attendPersons",width:"30",align:"center",searchtype:"string",sortable:true},
                    ...
                    {name:"statusName",width:"20",align:"center",searchtype:"string",sortable:true,formatter:'string'},
                    {name:"status",width:"20",align:"center",searchtype:"integer", sortable: true, hidden: true}
                ],
                actModel:[
                    {name:'operation', width:35, align:'center'}
                ],
                pager: '#pager2',
                caption:"质量安全监督记录（首次监督会议）列表",
                shrinkToFit:true,
    ...
    var TAB_NO = "tab1";
    function doView(id) {
        parent.openWindow("查看首次监督记录", "${ctx}/jdRecordFirst/view.do?id=" + id, false,900,500);
    }
    <c:if test="${canEdit}">
    function doAdd() {
        parent.openWindow("添加首次监督记录", "${ctx}/jdRecordFirst/add.do?jdcode=${code}" , true,900,500,TAB_NO);
    }
    function doEdit(id) {
        parent.openWindow("修改首次监督记录", "${ctx}/jdRecordFirst/modify.do?jdcode=${code}&id=" + id, true,900,500,TAB_NO);
    }
    function doDelete(id) {
        parent.doGridDelete("${ctx}/jdRecordFirst/delete.do?id=" + id, null, {iframeId:TAB_NO});
    }
    </c:if>
</script>
...
<div class="title_Search">
    <div class="gridQueryArea">
        ...
        <div style="float:left;padding-left: 10px" id="conditionsDesc">
            <input type="text" name="queryConditionDesc" id="queryConditionDesc" value="" class="title_input_short" readonly="true"/>
        </div>
