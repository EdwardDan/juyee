...
<script type="text/javascript">
    ...
    function doEdit(projectId, bidCountOfNode) {
        openWindow("修改项目形象进度推进", "${ctx}/dataNodeReport/modify.do?projectId=" + projectId, true, 800, 500);
    }
    function doView(projectId, bidCountOfNode) {
        openWindow("查看项目形象进度推进", "${ctx}/dataNodeReport/view.do?projectId=" + projectId, false, 800, 500);
    }
</script>
