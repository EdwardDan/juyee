...
<SCRIPT type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var setting = {
            simpleOpts:{
                treeUrl:CONTEXT_NAME + "/bpmFormTemplate/treeData.do?icon=" + icon, //树的链接
                isOpenRoot:true, //是否打开根节点
                clickOpts:{
                    "root":CONTEXT_NAME + "/bpmFormTemplate/grid.do",
                    "data":CONTEXT_NAME + "/bpmFormTemplate/grid.do?categoryId={id}",
                    "detail":["查看模板", CONTEXT_NAME + "/bpmFormTemplate/view.do?id={id}"]
                }
