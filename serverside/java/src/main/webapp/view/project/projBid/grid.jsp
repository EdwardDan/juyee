...
<script type="text/javascript">
    $(function () {
        var conf = {
            gridOpts:{
                url:"${ctx}/projBid/gridDataCustom.do",
                colNames:['ID',
            	'标段编号',            	          	
            	'标段名称',            	          	
            	'建设里程',            	          	
...
{name:"code",width:"133",align:"center",searchtype:"string",sortable:true},
{name:"name",width:"133",align:"center",searchtype:"string",sortable:true},
{name:"buildMileage",width:"133",align:"center",searchtype:"string",sortable:true},
{name:"projLink",width:"133",align:"center",searchtype:"string",sortable:true},
{name:"linkTel",width:"133",align:"center",searchtype:"string",sortable:true},
{name:"startDate",width:"133",align:"center",searchtype:"date",sortable:true}
                ],
                actModel:[
    ...
    <c:if test="${canEdit}">
    function doAdd() {
        openWindow("添加项目标段管理", "${ctx}/projBid/add.do", true);
    }
    function doEdit(id) {
