...
<div id="searchContainer" class="form_div tr_title"
    ...
    <form id="searchForm">
        <div id="firstRow">
            ...
            <label class="labelS"> 项目地址: </label><input type="text" id="projectAdd" name="projectAdd" class="input_text"
                                                        value="${address}">
            <input type="button" value="查询" onclick="search()" class="button_query"/>
            <input type="button" value="关闭" onclick="closeWindow()" class="button_back_long" name="button_back">
        </div>
    </form>
</div>
...
//        var projectName = document.getElementById("projectName");
        var buildAddress = document.getElementById("projectAdd");
    ...
    function refreshWindow() {
        window.location = "${ctx}/projectMajor/grid.do?queryValue=${queryValue}";
    }
        ...
        },
        {
            ...
            callback: function (p) {
                ...
                if (confirm("是否将该点标注为项目地点？\n当前坐标为：x:" + currPoint.lng + ",y:" + currPoint.lat)) {
                    $.ajax({
                        type: 'POST',
                        url: "${ctx}/projectMajor/saveMap.do",
