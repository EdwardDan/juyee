...
//        }
        ...
        //提交表单
        saveAjaxData("${ctx}/projectBidSign/save.do", formId);
    }
    //获取监督记录相关的工程信息
    function getProjectInfo(btn) {
        ...
        btn.disabled = true;
        $.ajax({
            url: CONTEXT_NAME + "/projectInfo/getProjectInfoByBjbh.do?bjbh=" + v,
            cache: false,
            data: "",
...
<form:form commandName="bean">
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
            ...
            <tr class="tr_dark">
                <td class="form_label_right">项目投标保证金(万元)：</td>
                <td class="form_content" colspan="3">
                    <form:input path="signAccount" cssClass="input_number"/>
                </td>
            </tr>
            <tr class="tr_button">
                <td colspan="4">
