                ...
                <tr class="tr_light">
                    ...
                    <td class="form_content">
                        <sys:code code="${PROJ_INFO_STAGE}" name="ProjStage" id="ProjStage" type="select"
                                  sysCodeDetailId="${bean.stage.id}" style="width:150px" disabled="true"/>
                    </td>
                ...
                <tr class="tr_light">
                    ...
                    <td class="form_content">
                        <sys:code code="${PORJECT_PROJ_PROPERTY}" name="projProperty" id="projProperty" type="select"
                                  sysCodeDetailId="${bean.projProperty.id}" style="width:150px" disabled="true"/>
                    </td>
                </tr>
                <tr class="tr_dark">
                ...
                <tr class="tr_dark">
                    ...
                    <td class="form_content">
                        <sys:code code="${PORJECT_ROAD_GRADE}" name="roadGrade" id="roadGrade" type="select"
                                  sysCodeDetailId="${bean.roadGrade.id}" style="width:150px" disabled="true"/>
                    </td>
                </tr>
                <tr class="tr_light">
                    ...
                    <td class="form_content" colspan="3">
                        <sys:code code="${PORJECT_ROAD_TEC_GRADE}" name="roadTecGrade" id="roadTecGrade" type="select"
                                  sysCodeDetailId="${bean.roadTecGrade.id}" style="width:150px;" disabled="true"/>
                    </td>
                </tr>
            </table>
        </fieldset>
