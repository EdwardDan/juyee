...
<script type="text/javascript">
    ...
    function doView(id) {
        openWindow("查看项目与单位关联", "${ctx}/projRelateDept/view.do?id=" + id, false);
    }
    <c:if test="${canEdit}">
    function doAdd() {
        openWindow("添加项目与单位关联", "${ctx}/projRelateDept/add.do", true);
    }
    function doEdit(id) {
        openWindow("修改项目与单位关联", "${ctx}/projRelateDept/modify.do?id=" + id, true);
    }    
