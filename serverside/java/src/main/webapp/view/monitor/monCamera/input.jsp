...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var validateCondition = [
            ...
            //{name:"description", rule:"validate[required,maxSize[200]]"}
...
//        }
        ...
        //提交表单
        saveAjaxData("${ctx}/monCamera/save.do", formId);
    }
</script>
<form:form commandName="bean">
    <form:hidden path="id"/>
    <input type="hidden" name="monServerId" value="${bean.monServer.id}"/>
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
            ...
            <tr class="tr_light">
                ...
                <td class="form_content">
                    <sys:code code="${monCameraType}" sysCodeDetailId="${bean.cameraType.id}" type="select" name="cameraType"/>
                </td>
            </tr>
            <tr class="tr_dark">
