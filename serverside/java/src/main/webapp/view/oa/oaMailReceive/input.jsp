...
//            {name: "content", rule: "validate[required]"},
    ...
    function save(btn) {
        ...
        //提交表单
        saveAjaxData("${ctx}/oaMailReceive/save.do", formId, backTabMsgSend);
    }
            ...
            <tr class="tr_light">
                ...
                <td class="form_content">
                    ...
                    &nbsp;<input type="button" value="通讯录" class="button_normal_long" ${disabled}
                                 onclick="parent.openWindow('选择用户','${ctx}/oaMailGroupUser/select.do?objId=receivePersonId&objName=receivePersons&tabNo=tab1',false,700,450,null)"/>
                </td>
            </tr>
            <tr class="tr_dark">
