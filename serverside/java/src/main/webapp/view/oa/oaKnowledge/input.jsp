...
<form:form commandName="bean">
    ...
    <table cellpadding="0" cellspacing="0" class="form_table">
        ...
        <tr class="tr_light">
            <td class="form_label">主要内容：</td>
            <td class="form_content" colspan="4">
                <form:textarea path="content" cssClass="input_textarea_long_height" cssStyle="width: 90%"/>
            </td>
        </tr>
        <tr class="tr_light">
