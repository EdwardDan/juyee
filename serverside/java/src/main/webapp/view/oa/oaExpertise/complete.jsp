...
//            {name: "auditMemo", rule: "validate[required,maxSize[1000]]"},
//        ];
    ...
    function audit(btn) {
        ...
        //提交表单
        saveAjaxData("${ctx}/oaExpertise/save.do?status=${STATUS_COMPLETE}", formId);
    }
...
<form:form commandName="bean">
    ...
    <div class="form_div">
        ...
        <fieldset style="width: 90%;margin:0px auto">
            ...
            <table cellpadding="0" cellspacing="0" class="form_table">
                <tr class="tr_light">
                    <td class="form_label_right" style="width: 14%">审核备注：</td>
                    <td class="form_content" colspan="3">
        ...
        <fieldset style="width: 90%;margin:0px auto">
            <legend class="form_legend">完成信息</legend>
            <table cellpadding="0" cellspacing="0" class="form_table">
                <tr class="tr_light">
                    <td class="form_label_right" style="width: 14%">学习情况：</td>
                    <td class="form_content" colspan="3">
                        <form:textarea path="studyDesc" cssClass="input_textarea_long" cssStyle="width: 91%"/>
                    </td>
                </tr>
                <tr class="tr_light">
                    <td class="form_label_right" style="width: 14%" nowrap>附件：</td>
