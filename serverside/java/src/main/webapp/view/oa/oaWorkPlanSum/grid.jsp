...
{name:"beginDate",width:"72",align:"center",searchtype:"date",sortable:true},
{name:"endDate",width:"72",align:"center",searchtype:"date",sortable:true},
{name:"documentId",width:"72",align:"center",searchtype:"string",sortable:true},
{name:"status",width:"72",align:"center",searchtype:"integer",sortable:true,formatter:'integer',formatoptions:{thousandsSeparator:",",defaulValue:0}},
{name:"leaderOpinion",width:"72",align:"center",searchtype:"string",sortable:true},
{name:"leaderAuditTime",width:"72",align:"center",searchtype:"datetime",sortable:true,formatter:'date',formatoptions:{srcformat:'Y-m-d H:i:s',newformat:'Y-m-d H:i:s'}},
{name:"leaderAuditUser",width:"72",align:"center",searchtype:"string",sortable:true},
...
{name:"updateUser",width:"72",align:"center",searchtype:"string",sortable:true}
            ...
            userOpts:{
            	...
            	{ "field":"状态", "op":"cn", "data":""},            	    
            	{ "field":"领导审核意见", "op":"cn", "data":""},            	    
                { "field":"领导审核时间", "op":"bw", "data":""},            	    
            	{ "field":"领导审核用户名", "op":"cn", "data":""},            	    
    ...
    function doView(id) {
        openWindow("查看科室上报汇总", "${ctx}/oaWorkPlanSum/view.do?id=" + id, false);
    }
    <c:if test="${canEdit}">
    function doAdd() {
        openWindow("添加科室上报汇总", "${ctx}/oaWorkPlanSum/add.do", true);
    }
    function doEdit(id) {
        openWindow("修改科室上报汇总", "${ctx}/oaWorkPlanSum/modify.do?id=" + id, true);
    }    
