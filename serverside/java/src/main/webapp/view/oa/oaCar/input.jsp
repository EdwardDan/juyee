    ...
    $(function () {
        ...
        var validateCondition = [
                                                                        //{name:"beginTime", rule:"validate[required,maxSize[7]]"},            
                                                                                                      ...
                                                                                                      //{name:"personNum", rule:"validate[required,custom[integer],maxSize[5]"},            
                                                                                                      //{name:"useCause", rule:"validate[required,maxSize[${prop.length}]]"},            
...
<form:form commandName="bean">
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
              ...
              <td class="form_content">
                        <form:input path="useCause" cssClass="input_text"/>						
                          </td>                                
            </tr>
                                    <tr class="tr_light">
