...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var validateCondition = [
                                                                        //{name:"orderNo", rule:"validate[required,custom[integer],maxSize[5]"},            
                                                                                                      //{name:"name", rule:"validate[required,maxSize[200]]"},            
                                                                                                      //{name:"model", rule:"validate[required,maxSize[200]]"},            
                                                                                                      //{name:"price", rule:"validate[required,custom[number],maxSize[10]"},
                                                                                                      //{name:"unit", rule:"validate[required,maxSize[50]]"},            
                                                                                                      //{name:"amount", rule:"validate[required,custom[number],maxSize[10]"},
...
<form:form commandName="bean">
    ...
    <div class="form_div">
        <table cellpadding="0" cellspacing="0" class="form_table">
              ...
              <td class="form_content">
                        <form:input path="model" cssClass="input_text"/>						
                          </td>                                
            </tr>
                                                <tr class="tr_dark">
              <td class="form_label">单价：</td>
              <td class="form_content">
                        <form:input path="price" cssClass="input_text"/>						
                          </td>                                
            </tr>
                                    <tr class="tr_light">
              <td class="form_label">单位：</td>
              <td class="form_content">
                        <form:input path="unit" cssClass="input_text"/>						
                          </td>                                
            </tr>
                                                <tr class="tr_dark">
              <td class="form_label">库存：</td>
              <td class="form_content">
                        <form:input path="amount" cssClass="input_text"/>						
                          </td>                                
            </tr>
                                    <tr class="tr_light">
