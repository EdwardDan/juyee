 ...
 */
public class JdRecordCompletePrint extends AbstractTableData {
    // 列名数组，保存程序数据集所有列名
    ...
    public void init() {
        ...
        valueList = jdRecordManager.getJdRecordCheckItemReportList(JspHelper.getLong(id));
    }
