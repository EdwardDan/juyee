 ...
 */
public class JdRecordQualityPrint extends AbstractTableData {
    ...
    public void init() {
        ...
        valueList = jdRecordManager.getJdRecordCheckBoxs(JspHelper.getLong(id), JdRecordType.TYPE_QUALITY.getCode());
    }
