...
public abstract class BaseSysRole implements Serializable, Auditable {
    ...
    // collections
    private java.util.Set<com.justonetech.system.domain.SysRolePrivilege> sysRolePrivileges;

    // collections
    private java.util.Set<com.justonetech.system.domain.SysUserRole> sysUserRoles;
    ...
    public Set<SysRolePrivilege> getSysRolePrivileges() {
        if (sysRolePrivileges == null) {
            sysRolePrivileges = new java.util.LinkedHashSet<com.justonetech.system.domain.SysRolePrivilege>();
        }
