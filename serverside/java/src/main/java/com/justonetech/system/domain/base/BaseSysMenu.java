...
public abstract class BaseSysMenu  implements Serializable,com.justonetech.core.entity.Treeable{
    ...
    // collections
	private java.util.Set<com.justonetech.system.domain.SysMenu> sysMenus;
	 ...
	 */
	public java.util.Set<com.justonetech.system.domain.SysMenu> getSysMenus () {
		if(sysMenus == null){
			sysMenus = new java.util.LinkedHashSet<com.justonetech.system.domain.SysMenu>();
		}
		return sysMenus;
	}
	 ...
	 */
	public void setSysMenus (java.util.Set<com.justonetech.system.domain.SysMenu> sysMenus) {
		this.sysMenus = sysMenus;
	}

	public void addTosysMenus (com.justonetech.system.domain.SysMenu sysMenu) {
		if (null == getSysMenus()) setSysMenus(new java.util.LinkedHashSet<com.justonetech.system.domain.SysMenu>());
