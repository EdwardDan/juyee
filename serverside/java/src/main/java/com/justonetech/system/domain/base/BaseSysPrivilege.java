...
public abstract class BaseSysPrivilege  implements Serializable,com.justonetech.core.entity.Treeable{
    ...
    // collections
    private java.util.Set<SysPrivilege> sysPrivileges;
    ...
    public Set<SysPrivilege> getSysPrivileges() {
        if (sysPrivileges == null) {
            sysPrivileges = new java.util.LinkedHashSet<com.justonetech.system.domain.SysPrivilege>();
        }
