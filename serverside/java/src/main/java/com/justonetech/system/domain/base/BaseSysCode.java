...
public abstract class BaseSysCode  implements Serializable, com.justonetech.core.entity.Treeable {
	...
	// collections
	private java.util.Set<com.justonetech.system.domain.SysCode> sysCodes;
	private java.util.Set<com.justonetech.system.domain.SysCodeDetail> sysCodeDetails;
	 ...
	 */
	public java.util.Set<com.justonetech.system.domain.SysCode> getSysCodes () {
		if(sysCodes == null){
			sysCodes = new java.util.LinkedHashSet<com.justonetech.system.domain.SysCode>();
		}
		return sysCodes;
	}
	 ...
	 */
	public void setSysCodes (java.util.Set<com.justonetech.system.domain.SysCode> sysCodes) {
		this.sysCodes = sysCodes;
	}

	public void addTosysCodes (com.justonetech.system.domain.SysCode sysCode) {
		if (null == getSysCodes()) setSysCodes(new java.util.LinkedHashSet<com.justonetech.system.domain.SysCode>());
	 ...
	 */
	public java.util.Set<com.justonetech.system.domain.SysCodeDetail> getSysCodeDetails () {
		if(sysCodeDetails == null){
			sysCodeDetails = new java.util.LinkedHashSet<com.justonetech.system.domain.SysCodeDetail>();
		}
	 ...
	 */
	public void setSysCodeDetails (java.util.Set<com.justonetech.system.domain.SysCodeDetail> sysCodeDetails) {
		this.sysCodeDetails = sysCodeDetails;
	}

	public void addTosysCodeDetails (com.justonetech.system.domain.SysCodeDetail sysCodeDetail) {
		if (null == getSysCodeDetails()) setSysCodeDetails(new java.util.LinkedHashSet<com.justonetech.system.domain.SysCodeDetail>());
