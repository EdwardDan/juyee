...
public class ParFileUtils {
    ...
    public static byte[] readFileContentFromZipfile(File parFile, String fileName) throws IOException {
    ...
    public static byte[] readFileContentFromByteArray(byte[] bytes, String fileName) throws IOException {
    ...
    public static ZipEntry[] readEntriesFromByteArray(byte[] bytes) throws IOException {
       File tempFile = File.createTempFile("parFile", ".tmp");
    ...
    public static ZipEntry[] readEntriesFromZipfile(File parFile) throws IOException {
        org.apache.tools.zip.ZipFile zipFile = new org.apache.tools.zip.ZipFile(parFile);
        java.util.Enumeration e = zipFile.getEntries();
        org.apache.tools.zip.ZipEntry zipEntry = null;
     ...
     *
     * @param parFile  压缩文件的路径
     * @param fileName 文件名称,含扩展名
     * @return .
     * @throws java.io.IOException .
     */

    public static String getContentFromPar(File parFile, String fileName) throws IOException {

        byte[] bytes = readFileContentFromZipfile(parFile, fileName);
        return new String(bytes);
    }

    public static String getContentFromPar(File parFile, String fileName, String encoding) throws IOException {
