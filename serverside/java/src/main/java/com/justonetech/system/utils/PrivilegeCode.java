...
public class PrivilegeCode {
    ...
    public static final String PROJ_EXTEND_EDIT = ProjExtend.class.getSimpleName() + "_edit";//项目基本信息管理_编辑
    ...
    public static final String OA_WORK_WATCH_AUDIT_B = "OaWorkWatch_audit_bgs";  // OA办公-工作督办_审核_办公室 已改成 工作督办_主任核实
