...
public class FileUtils {
     ...
     * @return
     */
    public static boolean checkFileExt(MultipartHttpServletRequest multipartRequest) {
     ...
     * 添加对url文件的判断
     *
     * @param fileName 可以为网络地址，比如http://xxx/a.jpg，也可以上fckeditor上传的图片地址，比如/mis/userfiles/image/00079166.jpg
     * @param ctx      图片路径
     * @return 是否存在
     */
     ...
     * @throws Exception .
     */
    public static void downloadSection(HttpServletRequest request, HttpServletResponse response, String filePath, String originalFileName, Boolean isOnLine) throws Exception {
...
//        copyFile("h:\\test.txt", "h:\\test2.txt");

        String url = "http://www.baidu.com";
        String toFile = "e:/test.html";
        url = "http://www.baidu.com/img/baidu_logo.gif";
        toFile = "e:/test.gif";
//        url = "http://localhost:8080/mis/docCommon/downloadByAttachmentId.do?attachmentId=1591&secondDir=";
//        toFile = "e:/test.mht";
