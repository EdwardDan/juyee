...
/**
 * This is an object that contains data related to the AREA_PERMIT_HD_EXTEND table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 区县施工许可_航道扩展信息
 * SyncTemplatepatterns : list\w*
 * SyncDao : false
 * TableName : 区县施工许可_航道扩展信息
 * SyncBoolean : get
 * SyncJsp : true
 * Treeable : false
 * SubSystem : area
 ...
 *
 * @hibernate.class
 *  table="AREA_PERMIT_HD_EXTEND"
 */

public abstract class BaseAreaPermitHdExtend  implements Serializable {

	public static String REF = "AreaPermitHdExtend";
	 ...
	 */
	public BaseAreaPermitHdExtend (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.AreaPermitHdExtend)) return false;
		else {
			com.justonetech.biz.domain.AreaPermitHdExtend areaPermitHdExtend = (com.justonetech.biz.domain.AreaPermitHdExtend) obj;
			if (null == this.getId() || null == areaPermitHdExtend.getId()) return false;
			else return (this.getId().equals(areaPermitHdExtend.getId()));
		}
	}
