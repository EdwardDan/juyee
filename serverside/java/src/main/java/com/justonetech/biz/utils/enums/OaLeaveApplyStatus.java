 ...
 * Date: 14-4-16
 */
public enum OaLeaveApplyStatus {
    STATUS_EDIT(1, "填写", "red"),
    STATUS_SUBMIT(2, "提交领导审核", "blue"),
...
//    STATUS_SUBMIT_LEADER(4, "领导审核", "blue"),
    ...
    private OaLeaveApplyStatus(int code, String name, String color) {
        this.code = code;
        this.name = name;
        this.color = color;
    }
    ...
    public static String getNameByCode(int code) {
        for (OaLeaveApplyStatus aType : values()) {
    ...
    public static String getOptions(String selectValue) {
        OaLeaveApplyStatus[] statuses = values();
