 ...
 * Date: 14-4-16
 */
public enum OaExpertiseStatus {
    STATUS_EDIT(1, "填写", "red"),
    STATUS_SUBMIT(2, "已提交", "blue"),
    STATUS_BACK(3, "退回修改", "red"),
    STATUS_PASS(4, "审核通过", "green"),
    STATUS_COMPLETE(5, "完成", "green");

    private int code;
    private String name;
    private String color;

    private OaExpertiseStatus(int code, String name, String color) {
        this.code = code;
        this.name = name;
        this.color = color;
    }
    ...
    public static String getNameByCode(int code) {
        for (OaExpertiseStatus aType : values()) {
    ...
    public static String getOptions(String selectValue) {
        OaExpertiseStatus[] statuses = values();
