...
/**
 * This is an object that contains data related to the AREA_PROJ_PERSON table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 区县合同项目负责人信息
 * SyncTemplatepatterns : list\w*
 * SyncDao : false
 * TableName : 区县合同项目负责人信息
 * SyncBoolean : get
 * SyncJsp : true
 * Treeable : false
 * SubSystem : area
 ...
 *
 * @hibernate.class
 *  table="AREA_PROJ_PERSON"
 */

public abstract class BaseAreaProjPerson  implements Serializable {

	public static String REF = "AreaProjPerson";
	 ...
	 */
	public BaseAreaProjPerson (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.AreaProjPerson)) return false;
		else {
			com.justonetech.biz.domain.AreaProjPerson areaProjPerson = (com.justonetech.biz.domain.AreaProjPerson) obj;
			if (null == this.getId() || null == areaProjPerson.getId()) return false;
			else return (this.getId().equals(areaProjPerson.getId()));
		}
	}
