...
/**
 * This is an object that contains data related to the SHARE_PRO_SG_INFO_LOG table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 施工承发包信息日志
 ...
 *
 * @hibernate.class
 *  table="SHARE_PRO_SG_INFO_LOG"
 */

public abstract class BaseShareProSgInfoLog  implements Serializable {

	public static String REF = "ShareProSgInfoLog";
	 ...
	 */
	public BaseShareProSgInfoLog (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSgInfoLog)) return false;
		else {
			com.justonetech.biz.domain.ShareProSgInfoLog shareProSgInfoLog = (com.justonetech.biz.domain.ShareProSgInfoLog) obj;
			if (null == this.getId() || null == shareProSgInfoLog.getId()) return false;
			else return (this.getId().equals(shareProSgInfoLog.getId()));
		}
	}
