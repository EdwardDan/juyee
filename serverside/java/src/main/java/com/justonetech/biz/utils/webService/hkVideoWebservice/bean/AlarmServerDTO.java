...
public class AlarmServerDTO {
    ...
    @XmlElementRef(name = "alarmSvId", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "notifyWay", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "smsCom", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "workMode", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
