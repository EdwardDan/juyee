...
/**
 * This is an object that contains data related to the SHARE_PRO_KC_INFO_LOG table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 项目勘察承发包信息日志
 * SyncTemplatepatterns : list\w*
 * SyncDao : false
 * TableName : 项目勘察承发包信息日志
 * SyncBoolean : get
 * SyncJsp : true
 * Treeable : false
 * SubSystem : share
 ...
 *
 * @hibernate.class
 *  table="SHARE_PRO_KC_INFO_LOG"
 */

public abstract class BaseShareProKcInfoLog  implements Serializable {

	public static String REF = "ShareProKcInfoLog";
	 ...
	 */
	public BaseShareProKcInfoLog (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProKcInfoLog)) return false;
		else {
			com.justonetech.biz.domain.ShareProKcInfoLog shareProKcInfoLog = (com.justonetech.biz.domain.ShareProKcInfoLog) obj;
			if (null == this.getId() || null == shareProKcInfoLog.getId()) return false;
			else return (this.getId().equals(shareProKcInfoLog.getId()));
		}
	}
