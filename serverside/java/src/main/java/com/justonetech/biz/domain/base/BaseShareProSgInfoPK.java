...
public abstract class BaseShareProSgInfoPK implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSgInfoPK)) return false;
		else {
			com.justonetech.biz.domain.ShareProSgInfoPK mObj = (com.justonetech.biz.domain.ShareProSgInfoPK) obj;
