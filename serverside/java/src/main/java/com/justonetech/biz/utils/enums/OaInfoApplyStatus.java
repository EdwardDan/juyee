 ...
 * Date: 14-2-27
 */
public enum OaInfoApplyStatus {
    STATUS_EDIT(1, "填写", "red"),
    STATUS_SUBMIT(2, "提交", "blue"),
    STATUS_BRANCH_PASS(3, "分管领导通过", "green"),
    STATUS_BRANCH_BACK(4, "分管领导退回", "red"),
    STATUS_MAIN_PASS(5, "主要领导通过", "green"),
    STATUS_MAIN_BACK(6, "主要领导退回", "red");

    private int code;
    private String name;
    private String color;

    private OaInfoApplyStatus(int code, String name, String color){
        this.code=code;
        this.name=name;
        this.color=color;
    }
    ...
    public static String getNameByCode(int code) {
        for (OaInfoApplyStatus aType : values()) {
    ...
    public static String getOptions(String selectValue) {
        OaInfoApplyStatus[] statuses = values();
