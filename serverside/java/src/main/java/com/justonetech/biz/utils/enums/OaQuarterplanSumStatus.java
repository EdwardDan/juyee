 ...
 * description:
 * User: subo
 * Date: 14-4-29 上午10:15
 */
public enum OaQuarterplanSumStatus {
    ...
    private OaQuarterplanSumStatus(int code, String name, String color) {
        this.code = code;
        this.name = name;
        this.color = color;
    }
    ...
    public static String getNameByCode(int code) {
        for (OaQuarterplanSumStatus aType : values()) {
    ...
    public static String getOptions(String selectValue) {
        OaQuarterplanSumStatus[] statuses = values();
