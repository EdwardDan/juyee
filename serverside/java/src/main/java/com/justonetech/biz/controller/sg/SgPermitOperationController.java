   ...
   /**
    ...
    public void gridDataCustom(HttpServletResponse response, String filters, String columns, int page, int rows, HttpSession session) {
        try {
            ...
            String hql = "from SgPermitOperation order by id desc";
            //增加自定义查询条件
    ...
    public String add(Model model) {
        SgPermitOperation sgPermitOperation = new SgPermitOperation();

        //如需增加其他默认值请在此添加
        model.addAttribute("bean", sgPermitOperation);

        return "view/sg/sgPermitOperation/input";
    }
    ...
    public String modify(Model model, Long id) {
        SgPermitOperation sgPermitOperation = sgPermitOperationService.get(id);
    ...
    public String view(Model model, Long id) {
        ...
        model.addAttribute("bean", sgPermitOperation);        
        return "view/sg/sgPermitOperation/view";
    }
    ...
    @RequestMapping
    public void save(HttpServletResponse response, @ModelAttribute("bean") SgPermitOperation entity, HttpServletRequest request) throws Exception {
        try {
            SgPermitOperation target;
            if (entity.getId() != null) {
                target = sgPermitOperationService.get(entity.getId());
            ...
            sgPermitOperationService.save(target);
    ...
    public void delete(HttpServletResponse response, Long id) throws Exception {
        sgPermitOperationService.delete(id);
