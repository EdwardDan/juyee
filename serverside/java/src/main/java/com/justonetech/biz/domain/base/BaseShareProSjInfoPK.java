...
public abstract class BaseShareProSjInfoPK implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSjInfoPK)) return false;
		else {
			com.justonetech.biz.domain.ShareProSjInfoPK mObj = (com.justonetech.biz.domain.ShareProSjInfoPK) obj;
