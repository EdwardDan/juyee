   ...
   /**
    ...
    public void gridDataCustom(HttpServletResponse response, String filters, String columns, int page, int rows, HttpSession session) {
        try {
            ...
            String hql = "from SlryQualify order by id desc";
            //增加自定义查询条件
    ...
    @RequestMapping
    public void save(HttpServletResponse response, @ModelAttribute("bean") SlryQualify entity, HttpServletRequest request) throws Exception {
        try {
            SlryQualify target;
