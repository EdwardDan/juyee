...
/**
 * This is an object that contains data related to the JD_RECORD_QUALITY table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 安全质量监督--质量监督
 * SyncTemplatepatterns : list\w*
 * SyncDao : false
 * TableName : 安全质量监督--质量监督
 * SyncBoolean : get
 * SyncJsp : true
 * Treeable : false
 * SubSystem : jd
 ...
 *
 * @hibernate.class
 *  table="JD_RECORD_QUALITY"
 */

public abstract class BaseJdRecordQuality  implements Serializable,Auditable {

	public static String REF = "JdRecordQuality";
	...
	public static String PROP_JD_INSPECTION = "jdInspection";
	...
	public static String PROP_INSPECTION_POSITION = "inspectionPosition";
	...
	public static String PROP_SCHEDULE_ITEMS = "scheduleItems";
	 ...
	 */
	public BaseJdRecordQuality (Long id) {
		this.setId(id);
		initialize();
	}
	...
	/**
	 * Return the value associated with the column: SCHEDULE_ITEMS
	 */
	...
	/**
	 * Set the value related to the column: SCHEDULE_ITEMS
	 * @param scheduleItems the SCHEDULE_ITEMS value
	 */
	...
	/**
	 * Return the value associated with the column: INSPECTION_POSITION
	 */
	...
	/**
	 * Set the value related to the column: INSPECTION_POSITION
	 * @param inspectionPosition the INSPECTION_POSITION value
	 */
	...
	/**
	 * Return the value associated with the column: JD_INSPECTION
	 */
	...
	/**
	 * Set the value related to the column: JD_INSPECTION
	 * @param jdInspection the JD_INSPECTION value
	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.JdRecordQuality)) return false;
		else {
			com.justonetech.biz.domain.JdRecordQuality jdRecordQuality = (com.justonetech.biz.domain.JdRecordQuality) obj;
			if (null == this.getId() || null == jdRecordQuality.getId()) return false;
			else return (this.getId().equals(jdRecordQuality.getId()));
		}
	}
	...
	public String toString () {
		...
		builder.append(scheduleItems);
		builder.append(notifyContent);
		builder.append(inspectionContent);
		builder.append(inspectionPosition);
		builder.append(jdInspection);
