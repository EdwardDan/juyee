...
/**
 * This is an object that contains data related to the SHARE_PRO_SJ_INFO_LOG table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 设计承发包信息日志
 ...
 *
 * @hibernate.class
 *  table="SHARE_PRO_SJ_INFO_LOG"
 */

public abstract class BaseShareProSjInfoLog  implements Serializable {

	public static String REF = "ShareProSjInfoLog";
	 ...
	 */
	public BaseShareProSjInfoLog (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSjInfoLog)) return false;
		else {
			com.justonetech.biz.domain.ShareProSjInfoLog shareProSjInfoLog = (com.justonetech.biz.domain.ShareProSjInfoLog) obj;
			if (null == this.getId() || null == shareProSjInfoLog.getId()) return false;
			else return (this.getId().equals(shareProSjInfoLog.getId()));
		}
	}
