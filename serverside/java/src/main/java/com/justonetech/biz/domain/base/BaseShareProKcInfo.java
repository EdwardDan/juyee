...
/**
 * This is an object that contains data related to the SHARE_PRO_KC_INFO table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 项目勘察承发包信息
 ...
 *
 * @hibernate.class
 *  table="SHARE_PRO_KC_INFO"
 */

public abstract class BaseShareProKcInfo  implements Serializable {

	public static String REF = "ShareProKcInfo";
	public static String PROP_TOTAL_INVESTMENT = "totalInvestment";
	public static String PROP_PROJECT_NAME = "projectName";
	public static String PROP_KC_FEE = "kcFee";
	 ...
	 */
	public BaseShareProKcInfo (com.justonetech.biz.domain.ShareProKcInfoPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.justonetech.biz.domain.ShareProKcInfoPK id;
    ...
    /*勘察费*/
    /*勘察费*/
	private java.lang.Double kcFee;
     ...
     * @hibernate.id
     */
	public com.justonetech.biz.domain.ShareProKcInfoPK getId () {
		return id;
	}
	 ...
	 * @deprecated
	 */
	public void setId (com.justonetech.biz.domain.ShareProKcInfoPK id) {
		this.id = id;
	...
	/**
	 * Return the value associated with the column: KC_FEE
	 */
	public java.lang.Double getKcFee () {
		return kcFee;
	}

	/**
	 * Set the value related to the column: KC_FEE
	 * @param kcFee the KC_FEE value
	 */
	public void setKcFee (java.lang.Double kcFee) {
		this.kcFee = kcFee;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProKcInfo)) return false;
		else {
			com.justonetech.biz.domain.ShareProKcInfo shareProKcInfo = (com.justonetech.biz.domain.ShareProKcInfo) obj;
			if (null == this.getId() || null == shareProKcInfo.getId()) return false;
			else return (this.getId().equals(shareProKcInfo.getId()));
		}
	}
