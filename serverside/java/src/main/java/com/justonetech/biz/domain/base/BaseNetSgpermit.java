...
/**
 * This is an object that contains data related to the NET_SGPERMIT table.
...
public abstract class BaseNetSgpermit  implements Serializable,Auditable {

	public static String REF = "NetSgpermit";
	 ...
	 */
	public BaseNetSgpermit (Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.NetSgpermit)) return false;
		else {
			com.justonetech.biz.domain.NetSgpermit netSgpermit = (com.justonetech.biz.domain.NetSgpermit) obj;
			if (null == this.getId() || null == netSgpermit.getId()) return false;
			else return (this.getId().equals(netSgpermit.getId()));
		}
	}
