...
/**
 * This is an object that contains data related to the SG_UNIT_PROJ table.
...
public abstract class BaseSgUnitProj  implements Serializable {

	public static String REF = "SgUnitProj";
	 ...
	 */
	public BaseSgUnitProj (java.lang.Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.SgUnitProj)) return false;
		else {
			com.justonetech.biz.domain.SgUnitProj sgUnitProj = (com.justonetech.biz.domain.SgUnitProj) obj;
			if (null == this.getId() || null == sgUnitProj.getId()) return false;
			else return (this.getId().equals(sgUnitProj.getId()));
		}
	}
