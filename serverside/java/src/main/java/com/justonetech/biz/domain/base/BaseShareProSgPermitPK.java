...
public abstract class BaseShareProSgPermitPK implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSgPermitPK)) return false;
		else {
			com.justonetech.biz.domain.ShareProSgPermitPK mObj = (com.justonetech.biz.domain.ShareProSgPermitPK) obj;
