...
/**
 * This is an object that contains data related to the OA_QUARTERPLAN table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 季度年度总结计划
 ...
 *
 * @hibernate.class
 *  table="OA_QUARTERPLAN"
 */

public abstract class BaseOaQuarterplan  implements Serializable{

	public static String REF = "OaQuarterplan";
	 ...
	 */
	public BaseOaQuarterplan (Long id) {
		this.setId(id);
		initialize();
	}
    ...
    public Boolean getIsSumDelete () {
    	...
    	/**
    	 * Set the value related to the column: IS_SUM_DELETE
    	 * @param isSumDelete the IS_SUM_DELETE value
    	 */
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.OaQuarterplan)) return false;
		else {
			com.justonetech.biz.domain.OaQuarterplan oaQuarterplan = (com.justonetech.biz.domain.OaQuarterplan) obj;
			if (null == this.getId() || null == oaQuarterplan.getId()) return false;
			else return (this.getId().equals(oaQuarterplan.getId()));
		}
	}
