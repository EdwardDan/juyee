...
/**
 * This is an object that contains data related to the DATA_STAGE_REPORT_ITEM table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 办证推进填报明细
...
public abstract class BaseDataStageReportItem  implements Serializable, Auditable {

	public static String REF = "DataStageReportItem";
	...
	// constructors
	public BaseDataStageReportItem () {
		initialize();
	}
	 ...
	 */
	public BaseDataStageReportItem (Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.DataStageReportItem)) return false;
		else {
			com.justonetech.biz.domain.DataStageReportItem dataStageReportItem = (com.justonetech.biz.domain.DataStageReportItem) obj;
			if (null == this.getId() || null == dataStageReportItem.getId()) return false;
			else return (this.getId().equals(dataStageReportItem.getId()));
		}
	}
