...
/**
 * This is an object that contains data related to the JD_RECORD_SAFE table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 安全质量监督--安全监督
 * SyncTemplatepatterns : list\w*
 * SyncDao : false
 * TableName : 安全质量监督--安全监督
 * SyncBoolean : get
 * SyncJsp : true
 * Treeable : false
 * SubSystem : jd
 ...
 *
 * @hibernate.class
 *  table="JD_RECORD_SAFE"
 */

public abstract class BaseJdRecordSafe  implements Serializable,Auditable {

	public static String REF = "JdRecordSafe";
	 ...
	 */
	public BaseJdRecordSafe (Long id) {
		this.setId(id);
		initialize();
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.JdRecordSafe)) return false;
		else {
			com.justonetech.biz.domain.JdRecordSafe jdRecordSafe = (com.justonetech.biz.domain.JdRecordSafe) obj;
			if (null == this.getId() || null == jdRecordSafe.getId()) return false;
			else return (this.getId().equals(jdRecordSafe.getId()));
		}
	}
