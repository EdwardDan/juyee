   ...
   /**
    ...
    public void gridDataCustom(HttpServletResponse response, String filters, String columns, int page, int rows, HttpSession session) {
        try {
            ...
            String hql = "from ProjRelateDept order by id desc";
            //增加自定义查询条件
    ...
    @RequestMapping
    public void save(HttpServletResponse response, @ModelAttribute("bean") ProjRelateDept entity, HttpServletRequest request) throws Exception {
        try {
            ProjRelateDept target;
            if (entity.getId() != null) {
                target = projRelateDeptService.get(entity.getId());
            ...
            projRelateDeptService.save(target);
