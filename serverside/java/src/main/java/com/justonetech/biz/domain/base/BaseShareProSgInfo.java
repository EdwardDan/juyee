...
/**
 * This is an object that contains data related to the SHARE_PRO_SG_INFO table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 施工承发包信息
 ...
 *
 * @hibernate.class
 *  table="SHARE_PRO_SG_INFO"
 */

public abstract class BaseShareProSgInfo  implements Serializable {

	public static String REF = "ShareProSgInfo";
	...
	public static String PROP_SG_FEE = "sgFee";
	 ...
	 */
	public BaseShareProSgInfo (com.justonetech.biz.domain.ShareProSgInfoPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.justonetech.biz.domain.ShareProSgInfoPK id;
    ...
    /*施工中标价*/
    /*施工中标价*/
	private java.lang.Double sgFee;
     ...
     * @hibernate.id
     */
	public com.justonetech.biz.domain.ShareProSgInfoPK getId () {
		return id;
	}
	 ...
	 * @deprecated
	 */
	public void setId (com.justonetech.biz.domain.ShareProSgInfoPK id) {
		this.id = id;
	...
	/**
	 * Return the value associated with the column: SG_FEE
	 */
	public java.lang.Double getSgFee () {
		return sgFee;
	}

	/**
	 * Set the value related to the column: SG_FEE
	 * @param sgFee the SG_FEE value
	 */
	public void setSgFee (java.lang.Double sgFee) {
		this.sgFee = sgFee;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSgInfo)) return false;
		else {
			com.justonetech.biz.domain.ShareProSgInfo shareProSgInfo = (com.justonetech.biz.domain.ShareProSgInfo) obj;
			if (null == this.getId() || null == shareProSgInfo.getId()) return false;
			else return (this.getId().equals(shareProSgInfo.getId()));
		}
	}
