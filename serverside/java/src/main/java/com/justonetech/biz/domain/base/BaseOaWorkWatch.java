...
public abstract class BaseOaWorkWatch  implements Serializable {
	...
	public void addTooaWorkWatchItems (com.justonetech.biz.domain.OaWorkWatchItem oaWorkWatchItem) {
		if (null == getOaWorkWatchItems()) setOaWorkWatchItems(new java.util.LinkedHashSet<com.justonetech.biz.domain.OaWorkWatchItem>());
