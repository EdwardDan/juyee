...
public abstract class BaseShareProKcInfoPK implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProKcInfoPK)) return false;
		else {
			com.justonetech.biz.domain.ShareProKcInfoPK mObj = (com.justonetech.biz.domain.ShareProKcInfoPK) obj;
