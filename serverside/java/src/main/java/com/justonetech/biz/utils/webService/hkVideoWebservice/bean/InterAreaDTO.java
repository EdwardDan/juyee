...
public class InterAreaDTO {
    ...
    @XmlElementRef(name = "clientPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "interAreaId", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "ptzPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "streamPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    protected JAXBElement<Integer> streamPort;
    @XmlElementRef(name = "type", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
    protected JAXBElement<Integer> type;
    @XmlElementRef(name = "uaPort", namespace = "http://bo.webservice.cms.hikvision.com/xsd", type = JAXBElement.class)
