...
public enum OaCarApplyStatus {
    ...
    private OaCarApplyStatus(int code, String name, String color) {
        this.code = code;
        this.name = name;
        this.color = color;
    }
    ...
    public static String getNameByCode(int code) {
        for (OaCarApplyStatus aType : values()) {
    ...
    public static String getOptions(String selectValue) {
        OaCarApplyStatus[] statuses = values();
