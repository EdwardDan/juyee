...
import com.justonetech.biz.utils.DBUtil;
import com.justonetech.biz.utils.excel.ExcelData;
import com.justonetech.biz.utils.excel.Importer;
...
import com.justonetech.system.manager.ExcelLoaderManager;
...
public class OaPetitionController extends BaseCRUDActionController<OaPetition> {
    ...
    @Autowired
    private ExcelLoaderManager excelLoaderManager;
