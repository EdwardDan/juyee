...
/**
 * This is an object that contains data related to the SHARE_PRO_SJ_INFO table.
 * Do not modify this class because it will be overwritten if the configuration file
 * related to this class is modified.
 * TableComment : 设计承发包信息
 ...
 *
 * @hibernate.class
 *  table="SHARE_PRO_SJ_INFO"
 */

public abstract class BaseShareProSjInfo  implements Serializable {

	public static String REF = "ShareProSjInfo";
	...
	public static String PROP_SJ_FEE = "sjFee";
	 ...
	 */
	public BaseShareProSjInfo (com.justonetech.biz.domain.ShareProSjInfoPK id) {
		this.setId(id);
		initialize();
	}
	...
	// primary key
	private com.justonetech.biz.domain.ShareProSjInfoPK id;
    ...
    /*设计费*/
    /*设计费*/
	private java.lang.Double sjFee;
     ...
     * @hibernate.id
     */
	public com.justonetech.biz.domain.ShareProSjInfoPK getId () {
		return id;
	}
	 ...
	 * @deprecated
	 */
	public void setId (com.justonetech.biz.domain.ShareProSjInfoPK id) {
		this.id = id;
	...
	/**
	 * Return the value associated with the column: SJ_FEE
	 */
	public java.lang.Double getSjFee () {
		return sjFee;
	}

	/**
	 * Set the value related to the column: SJ_FEE
	 * @param sjFee the SJ_FEE value
	 */
	public void setSjFee (java.lang.Double sjFee) {
		this.sjFee = sjFee;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.justonetech.biz.domain.ShareProSjInfo)) return false;
		else {
			com.justonetech.biz.domain.ShareProSjInfo shareProSjInfo = (com.justonetech.biz.domain.ShareProSjInfo) obj;
			if (null == this.getId() || null == shareProSjInfo.getId()) return false;
			else return (this.getId().equals(shareProSjInfo.getId()));
		}
	}
